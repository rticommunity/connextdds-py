...
void init_class_defs(py::class_<DataWriterQos>& cls)
{
    cls.def(py::init<>(),
            ...
            .def(py::init([](const PyIAnyDataWriter& dw) {
                     return dw.py_qos();
                 }),
                 py::arg("writer"),
    ...
    add_qos_property<DataWriterQos, Durability>(
            cls,
            "durability",
            "Durability");
    add_qos_property<DataWriterQos, DurabilityService>(
            cls,
            "durability_service",
            "DurabilityService");
    add_qos_property<DataWriterQos, Deadline>(cls, "deadline", "Deadline");
    add_qos_property<DataWriterQos, LatencyBudget>(
            cls,
            "latency_budget",
            "LatencyBudget");
    add_qos_property<DataWriterQos, Liveliness>(
            cls,
            "liveliness",
            "Liveliness");
    add_qos_property<DataWriterQos, Reliability>(
            cls,
            "reliability",
            "Reliability");
    add_qos_property<DataWriterQos, DestinationOrder>(
            cls,
            "destination_order",
            "DestinationOrder");
    add_qos_property<DataWriterQos, History>(cls, "history", "History");
    add_qos_property<DataWriterQos, ResourceLimits>(
            cls,
            "resource_limits",
            "ResourceLimits");
    add_qos_property<DataWriterQos, TransportPriority>(
            cls,
            "transport_priority",
            "TransportPriority");
    ...
    add_qos_property<DataWriterQos, OwnershipStrength>(
            cls,
            "ownership_strength",
            "OwnershipStrength");
    ...
    add_qos_property<DataWriterQos, TransportSelection>(
            ...
            "transport_selection",
            "TransportSelection");
    add_qos_property<DataWriterQos, TransportUnicast>(
            cls,
            "transport_unicast",
            "TransportUnicast");
    add_qos_property<DataWriterQos, PublishMode>(
            cls,
            "publish_mode",
            "PublishMode");
    ...
    add_qos_property<DataWriterQos, MultiChannel>(
            cls,
            "multi_channel",
            "MultiChannel");
    add_qos_property<DataWriterQos, Availability>(
            cls,
            "availability",
            "Availability");
    add_qos_property<DataWriterQos, EntityName>(
            cls,
            "entity_name",
            "EntityName");
    add_qos_property<DataWriterQos, TopicQueryDispatch>(
            ...
            "TopicQueryDispatch");
    add_qos_property<DataWriterQos, TypeSupport>(
            cls,
            "type_support",
            "TypeSupport");
