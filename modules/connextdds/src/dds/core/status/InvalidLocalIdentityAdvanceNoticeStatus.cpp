...
template<>
void init_class_defs(py::class_<InvalidLocalIdentityAdvanceNoticeStatus>& cls)
{
...
template<>
void process_inits<InvalidLocalIdentityAdvanceNoticeStatus>(
        py::module& m,
        ClassInitList& l)
{
    l.push_back([m]() mutable {
        return init_class<InvalidLocalIdentityAdvanceNoticeStatus>(
                m,
