...
void init_class_defs(py::class_<Logger>& cls)
{
    cls.def_property_readonly_static(
            ...
            .def_property(
                    ...
                    "The message format that RTI Connext will use to log "
                    "diagnostic "
                    "information.")
            .def("verbosity_by_category",
                 (Verbosity(Logger::*)(LogCategory))
    ...
    init_dds_safe_enum<Verbosity_def>(m, "Verbosity", [](py::object& o) {
        py::enum_<Verbosity::type>(o, "Verbosity")
                ...
                .value("EXCEPTION",
                       ...
                       "\n\n"
                       "An error indicates something wrong in the functioning "
                       "of RTI "
                ...
                .value("WARNING",
                       ...
                       "\n\n"
                       "A warning indicates that RTI Connext is taking an "
                       "action that "
                       "may or may not be what you intended. Some "
                       "configuration "
                       "information is also logged at this verbosity to aid in "
                       "debugging.")
                .value("STATUS_LOCAL",
                       Verbosity::type::STATUS_LOCAL,
                       "Errors, warnings, and verbose information about the "
                       "lifecycles "
                ...
                .value("STATUS_ALL",
                       ...
                       "Errors, warnings, verbose information about the "
                       "lifecycles of "
                       "local and remote RTI Connext objects, and periodic "
                       "information "
    ...
    init_dds_safe_enum<PrintFormat_def>(m, "PrintFormat", [](py::object& o) {
        py::enum_<PrintFormat::type>(o, "PrintFormat")
                ...
                .value("TIMESTAMPED",
                       ...
                       "Print message, method name, activity context, and "
                       "timestamp.")
                .value("VERBOSE",
                ...
                .value("DEBUG",
                       ...
                       "Print a set of field that may be useful for internal "
                       "debug.")
                .value("MINIMAL",
