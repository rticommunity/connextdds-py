...
void init_class_defs(py::class_<PyBuiltinProfiles>& cls)
{
    cls.def_property_readonly_static(
            ...
            .def_property_readonly_static(
                    "generic_common",
                    [](py::object&) { return generic_common(); },
            ...
            .def_property_readonly_static(
                    ...
                    "The profile name forcompatibility with other vendor DDS "
                    "products.")
            .def_property_readonly_static(
                    "generic_other_dds_vendor_compatibility",
                    [](py::object&) {
            ...
            .def_property_readonly_static(
                    ...
                    "The profile name for reliable high-throughput "
                    "communication.")
            .def_property_readonly_static(
            ...
            .def_property_readonly_static(
                    ...
                    "The profile name for sending large data with strict "
                    "reliability.")
            .def_property_readonly_static(
                    ...
                    "The profile name for sending keep-last reliable large "
                    "data.")
            .def_property_readonly_static(
            ...
            .def_property_readonly_static(
                    ...
                    "The profile name for sending keep-last large reliable "
                    "data "
                    "with fast flow.")
            .def_property_readonly_static(
            ...
            .def_property_readonly_static(
                    ...
                    "The profile name for keeping data that persists as long "
                    "as the "
                    "DataWriter is alive.")
            .def_property_readonly_static(
            ...
            .def_property_readonly_static(
                    ...
                    "The profile name for using Persistence Service to persist "
                    "data "
                    "to disk.")
            .def_property_readonly_static(
                    "generic_auto_tuning",
                    [](py::object&) { return generic_auto_tuning(); },
                    "The profile name that enables Turbo Mode batching and "
                    "auto "
            ...
            .def_property_readonly_static(
                    "pattern_streaming",
                    [](py::object&) { return pattern_streaming(); },
            ...
            .def_property_readonly_static(
                    ...
                    "The profile name for a reliable streaming communication "
                    "pattern.")
            .def_property_readonly_static(
                    "pattern_event",
                    [](py::object&) { return pattern_event(); },
                    "The profile name for a pattern modeling event "
                    "communication.")
            .def_property_readonly_static(
                    "pattern_alarm_event",
            ...
            .def_property_readonly_static(
                    "pattern_status",
                    [](py::object&) { return pattern_status(); },
                    "The profile name for a pattern modeling status "
                    "communication.")
            .def_property_readonly_static(
            ...
            .def_property_readonly_static(
                    ...
                    "The profile name for a pattern modeling a last value "
                    "cache.");
}
