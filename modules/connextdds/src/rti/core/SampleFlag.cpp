...
void init_class_defs(py::class_<SampleFlag>& cls)
{
    cls.def(
            ...
            .def_property_readonly_static(
                    ...
                    [](py::object&) {
                        return SampleFlag::intermediate_reply_sequence();
                    },
            ...
            .def_property_readonly_static(
                    ...
                    [](py::object&) {
                        return SampleFlag::last_shared_reader_queue();
                    },
            ...
            .def_property_readonly_static(
                    ...
                    [](py::object&) {
                        return SampleFlag::intermediate_topic_query_sample();
                    },
