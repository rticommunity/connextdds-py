...
void init_class_defs(py::class_<Batch>& cls)
{
    cls.def(py::init<>(),
            ...
            .def_property(
                    ...
                    "Get/set boolean that specifies whether batching is "
                    "enabled.")
            .def_property(
                    "max_data_bytes",
                    (int32_t(Batch::*)() const) & Batch::max_data_bytes,
                    (Batch & (Batch::*) (int32_t)) & Batch::max_data_bytes,
                    "Get/set the maximum cummulative size of serialized "
                    "samples in a "
                    "batch. When this limit is reached the batch will be "
                    "flushed.")
            .def_property(
                    "max_samples",
                    (int32_t(Batch::*)() const) & Batch::max_samples,
                    (Batch & (Batch::*) (int32_t)) & Batch::max_samples,
                    "Get/set the maximum number of serialized samples in a "
                    "batch. "
            ...
            .def_property(
                    ...
                    "Get/set the maximum delay to flush a batch, measured from "
                    "the "
                    "time the first sample in the batch is written.")
            .def_property(
                    "source_timestamp_resolution",
                    (Duration(Batch::*)() const)
                            & Batch::source_timestamp_resolution,
                    (Batch & (Batch::*) (const Duration&) )
                            & Batch::source_timestamp_resolution,
                    "Get/set the timestamp resolution of the samples in the "
                    "batch.")
            .def_property(
                    "thread_safe_write",
            ...
            .def_static(
                    ...
                    "Create a Batch policy with batching enabled that will "
                    "flush "
