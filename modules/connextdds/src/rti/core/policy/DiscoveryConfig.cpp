...
void init_class_defs(py::class_<DiscoveryConfig>& cls)
{
    cls.def(py::init<>(), "Creates the default policy.")
            ...
            .def_property(
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (RemoteParticipantPurgeKind))
                            & DiscoveryConfig::remote_participant_purge_kind,
            ...
            .def_property(
                    ...
                    (DiscoveryConfig & (DiscoveryConfig::*) (int32_t))
                            & DiscoveryConfig::
                                    initial_participant_announcements,
                    "The number of initial announcements sent when a "
                    "participant is "
            ...
            .def_property(
                    ...
                    "participant is first enabled or when a remote participant "
                    "is "
                    "newly discovered."
                    "\n\n"
                    "This property's getter returns a deep copy.")
            ...
            .def_property(
                    ...
                    (BuiltinTopicReaderResourceLimits & (DiscoveryConfig::*) ())
                            & DiscoveryConfig::
                                    participant_reader_resource_limits,
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const BuiltinTopicReaderResourceLimits&) )
                            & DiscoveryConfig::
                                    participant_reader_resource_limits,
                    "Resource limits.")
            .def_property(
                    ...
                    "reliable reader associated to a built-in publication "
                    "reader.")
            .def_property(
            ...
            .def_property(
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const RtpsReliableReaderProtocol&) )
                            & DiscoveryConfig::subscription_reader,
                    "RTPS protocol-related configuration settings for the RTPS "
                    "reliable reader associated to a built-in subscription "
                    "reader.")
            .def_property(
            ...
            .def_property(
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const RtpsReliableWriterProtocol&) )
                            & DiscoveryConfig::publication_writer,
                    "RTPS protocol-related configuration settings for the RTPS "
                    "reliable writer associated to a built-in publication "
                    "reader.")
            .def_property(
                    ...
                    (dds::core::policy::WriterDataLifecycle
                     & (DiscoveryConfig::*) ())
                            & DiscoveryConfig::
                                    publication_writer_data_lifecycle,
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const dds::core::policy::
                                                     WriterDataLifecycle&) )
                            & DiscoveryConfig::
                                    publication_writer_data_lifecycle,
                    "riter data lifecycle settings for a built-in publication "
                    "writer.")
            .def_property(
                    "subscription_writer",
                    (RtpsReliableWriterProtocol & (DiscoveryConfig::*) ())
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const RtpsReliableWriterProtocol&) )
                            & DiscoveryConfig::subscription_writer,
                    "RTPS protocol-related configuration settings for the RTPS "
                    "reliable writer associated to a built-in subscription "
                    "reader.")
            .def_property(
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const dds::core::policy::
                            ...
                            & DiscoveryConfig::
                                    subscription_writer_data_lifecycle,
                    "riter data lifecycle settings for a built-in subscription "
                    "writer.")
            .def_property(
                    "builtin_discovery_plugins",
                    (DiscoveryConfigBuiltinPluginKindMask(DiscoveryConfig::*)()
                             const)
            ...
            .def_property(
                    ...
                    (dds::core::policy::ReliabilityKind(DiscoveryConfig::*)()
                            ...
                            & DiscoveryConfig::
                                    participant_message_reader_reliability_kind,
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (dds::core::policy::
                                                     ReliabilityKind))
                            & DiscoveryConfig::
                                    participant_message_reader_reliability_kind,
                    "Reliability policy for a built-in participant message "
                    "reader.")
            .def_property(
            ...
            .def_property(
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const PublishMode&) )
                            & DiscoveryConfig::publication_writer_publish_mode,
            ...
            .def_property(
                    ...
                    (AsynchronousPublisher & (DiscoveryConfig::*) ())
                            & DiscoveryConfig::asynchronous_publisher,
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const AsynchronousPublisher&) )
                            & DiscoveryConfig::asynchronous_publisher,
                    "Asynchronous publishing settings for the discovery "
                    "Publisher and "
            ...
            .def_property(
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const dds::core::Duration&) )
                            & DiscoveryConfig::
                                    default_domain_announcement_period,
                    "The period to announce a participant to the default "
                    "domain 0."
                    "\n\n"
                    "This property's getter returns a deep copy.")
            .def_property(
                    "ignore_default_domain_announcements",
                    (bool (DiscoveryConfig::*)() const)
                            & DiscoveryConfig::
                                    ignore_default_domain_announcements,
                    (DiscoveryConfig & (DiscoveryConfig::*) (bool) )
                            & DiscoveryConfig::
                                    ignore_default_domain_announcements,
                    "Used to ignore the announcements received by a "
                    "participant on "
                    "the default domain 0 corresponding to participants "
                    "running on "
            ...
            .def_property(
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const dds::core::policy::
                            ...
                            & DiscoveryConfig::
                                    service_request_writer_data_lifecycle,
                    "Writer data lifecycle settings for a built-in "
                    "ServiceRequest "
                    "writer.")
            .def_property(
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const PublishMode&) )
                            & DiscoveryConfig::
                                    service_request_writer_publish_mode,
                    "Publish mode policy for the built-in service request "
                    "writer.")
            .def_property(
            ...
            .def_property(
                    ...
                    (DiscoveryConfig
                     & (DiscoveryConfig::*) (const dds::core::Duration&) )
                            & DiscoveryConfig::
                                    locator_reachability_assert_period,
                    "Period at which this DomainParticipant will assert the "
                    "locators "
            ...
            .def_property(
                    ...
                    "consider one of their locators as \"unreachable\" if they "
                    "do not "
...
{
    init_dds_safe_enum<RemoteParticipantPurgeKind_def>(
            m,
                ...
                py::enum_<RemoteParticipantPurgeKind::type>(o, "RemoteParticipantPurgeKind")
                        .value("LIVELINESS_BASED",
                               RemoteParticipantPurgeKind::type::
                                       LIVELINESS_BASED,
                               "[default] Maintain knowledge of the remote "
                               "participant for as "
                               "long as it maintains its liveliness contract."
                               "\n\n"
                               "A participant will continue attempting "
                               "communication with its "
                               "peers, even if discovery communication with "
                               "them is lost, as "
                               "long as the remote participants maintain their "
                               "liveliness. If "
                               "both discovery communication and participant "
                               "liveliness are "
                               "lost, however, the local participant will "
                               "remove all records of "
                               "the remote participant and its contained "
                               "endpoints, and no "
                               "further data communication with them will "
                               "occur until and unless "
                               "they are rediscovered."
                               "\n\n"
                               "The liveliness contract a participant promises "
                               "to its peers "
                               "(its \"liveliness lease duration\") is "
                               "specified in its "
                               "DiscoveryConfig.participant_liveliness_lease_"
                               "duration QoS field. "
                               "It maintains that contract by writing data to "
                               "those other "
                               "participants with a writer that has a "
                               "LivelinessKind of "
                               "LivelinessKind.AUTOMATIC or "
                               "LivelinessKind.MANUAL_BY_PARTICIPANT "
                               "and by asserting itself (at the "
                               "DiscoveryConfig.participant_liveliness_assert_"
                               "period) over the "
                               "Simple Discovery Protocol.")
                        .value("NO_PURGE",
                               RemoteParticipantPurgeKind::type::NO_PURGE,
                               "Never \"forget\" a remote participant with "
                               "which discovery "
                               "communication has been lost."
                               "\n\n"
                               "If a participant with this behavior loses "
                               "discovery communication "
                               "with a remote participant, it will "
                               "nevertheless remember that "
                               "remote participant and its endpoints and "
                               "continue attempting to "
                               "communicate with them indefinitely."
                               "\n\n"
                               "This value has consequences for a "
                               "participant's resource usage. "
                               "If discovery communication with a remote "
                               "participant is lost, "
                               "but the same participant is later "
                               "rediscovered, any relevant "
                               "records that remain in the database will be "
                               "reused. However, if "
                               "it is not rediscovered, the records will "
                               "continue to take up "
                               "space in the database for as long as the local "
                               "participant "
