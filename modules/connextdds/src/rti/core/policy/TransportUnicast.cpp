...
void init_class_defs(py::class_<TransportUnicastSettings>& cls)
{
    cls.def(py::init<>(), "Creates the default policy.")
            ...
            .def_property(
                    "transports",
                    (std::vector<std::string>(TransportUnicastSettings::*)()
                             const)
                            & TransportUnicastSettings::transports,
                    (TransportUnicastSettings
                     & (TransportUnicastSettings::*) (const std::vector<
                                                      std::string>&) )
                            & TransportUnicastSettings::transports,
                    "A sequence of transport aliases that specifies the "
                    "unicast "
                    "interfaces on which to receive unicast traffic for the "
                    "entity."
                    "\n\n"
            ...
            .def_property(
                    ...
                    (TransportUnicastSettings
                     & (TransportUnicastSettings::*) (int32_t))
                            & TransportUnicastSettings::receive_port,
...
void init_class_defs(py::class_<TransportUnicast>& cls)
{
    cls.def(py::init<>(), "Creates the default policy.")
            ...
            .def_property(
                    ...
                    (TransportUnicast
                     & (TransportUnicast::*) (const std::vector<
                                              TransportUnicastSettings>&) )
                            & TransportUnicast::settings,
