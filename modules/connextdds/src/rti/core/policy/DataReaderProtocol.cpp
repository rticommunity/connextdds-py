    ...
    cls.def(py::init<>(), "Create a default DataReaderProtocol policy.")
            ...
            .def_property(
                    ...
                    (DataReaderProtocol & (DataReaderProtocol::*) (bool) )
                            & DataReaderProtocol::expects_inline_qos,
                    "Get/set the boolean for whether the reader will expect "
                    "inline "
            ...
            .def_property(
                    ...
                    (DataReaderProtocol & (DataReaderProtocol::*) (bool) )
                            & DataReaderProtocol::
                                    propagate_dispose_of_unregistered_instances,
                    "Get/set the boolean for whether an instance can move to "
                    "the "
                    "not_alive_disposed state without being in the alive "
                    "state.")
            .def_property(
                    ...
                    "Get/set the boolean for whether an instance can move to "
                    "the "
                    "not_alive_no_writers state without being in the alive "
                    "state.")
            .def_property(
