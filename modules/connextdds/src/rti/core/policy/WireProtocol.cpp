...
void init_class_defs(py::class_<WireProtocol>& cls)
{
    cls.def(py::init<>(), "Creates the default policy.")
            ...
            .def_property(
                    ...
                    (WireProtocol
                     & (WireProtocol::*) (const RtpsWellKnownPorts&) )
                            & WireProtocol::rtps_well_known_ports,
            ...
            .def_property(
                    ...
                    (RtpsReservedPortKindMask(WireProtocol::*)() const)
                            & WireProtocol::rtps_reserved_port_mask,
                    (WireProtocol
                     & (WireProtocol::*) (const RtpsReservedPortKindMask&) )
                            & WireProtocol::rtps_reserved_port_mask,
                    "Specifies which well-known ports to reserve when enabling "
                    "the "
                    "participant."
                    "\n\n"
                    "This property's getter returns a deep copy.")
            ...
            .def_property(
                    "compute_crc",
                    (bool (WireProtocol::*)() const)
                            & WireProtocol::compute_crc,
                    (WireProtocol & (WireProtocol::*) (bool) )
                            & WireProtocol::compute_crc,
                    "Adds RTPS CRC submessage to every message when this field "
                    "is set "
                    "to true.")
            .def_property(
                    "check_crc",
                    ...
                    "Checks if the received RTPS message is valid by comparing "
                    "the "
                    "computed CRC with the received RTPS CRC submessage when "
                    "this "
                    "field is set to true.")
            .def_readonly_static(
                    "RTPS_AUTO_ID",
                    &WireProtocol::RTPS_AUTO_ID,
                    "Indicates that RTI Connext should choose an appropriate "
                    "host, "
