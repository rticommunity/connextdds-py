...
{
    cls.def(py::init<>(), "Create a default AsynchronousPublisher QoS policy.")
            .def_property(
                    "disable_asynchronous_write",
                    (bool (AsynchronousPublisher::*)() const)
                            & AsynchronousPublisher::disable_asynchronous_write,
                    (AsynchronousPublisher & (AsynchronousPublisher::*) (bool) )
                            & AsynchronousPublisher::disable_asynchronous_write,
                    "Get/set the asynchronous write capability for this "
                    "policy.")
            .def_property(
                    "thread",
                    (ThreadSettings & (AsynchronousPublisher::*) ())
                            & AsynchronousPublisher::thread,
                    (AsynchronousPublisher
                     & (AsynchronousPublisher::*) (const ThreadSettings&) )
                            & AsynchronousPublisher::thread,
                    "Get/set the settings associated with the asynchronous "
                    "publisher "
                    "thread.")
            .def_property(
                    ...
                    (AsynchronousPublisher & (AsynchronousPublisher::*) (bool) )
                            & AsynchronousPublisher::disable_asynchronous_batch,
                    "Get/set the asynchronous batch flushing capability for "
                    "this "
                    "policy.")
            .def_property(
            ...
            .def_property(
                    ...
                    (AsynchronousPublisher & (AsynchronousPublisher::*) (bool) )
                            & AsynchronousPublisher::
                                    disable_topic_query_publication,
                    "Get/set the topic query publication capability for this "
                    "policy.")
            .def_property(
                    ...
                    (AsynchronousPublisher
                     & (AsynchronousPublisher::*) (const ThreadSettings&) )
                            & AsynchronousPublisher::
                                    topic_query_publication_thread,
                    "Get/set the settings associated with the topic query "
                    "publication "
                    "thread.")
            .def_static(
                    "enabled",
