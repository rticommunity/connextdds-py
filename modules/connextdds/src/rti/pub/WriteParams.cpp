...
void init_class_defs(py::class_<WriteParams>& cls)
{
    cls.def(py::init<>(), "Create a WriteParams object with default values.")
            ...
            .def_property(
                    ...
                    (WriteParams
                     & (WriteParams::*) (const rti::core::SampleIdentity&) )
                            & WriteParams::identity,
                    "The sample identity.")
            .def_property(
            ...
            .def_property(
                    "cookie",
                    (rti::core::Cookie(WriteParams::*)() const)
                            & WriteParams::cookie,
            ...
            .def_property(
                    ...
                    (dds::core::InstanceHandle(WriteParams::*)() const)
                            & WriteParams::handle,
                    (WriteParams
                     & (WriteParams::*) (const dds::core::InstanceHandle&) )
                            & WriteParams::handle,
                    "The instance handle for writing.")
            .def_property(
                    "priortiy",
                    (int32_t(WriteParams::*)() const) & WriteParams::priority,
                    (WriteParams & (WriteParams::*) (int32_t))
                            & WriteParams::priority,
                    "The priority for writing.")
            .def_property(
                    "flag",
                    (rti::core::SampleFlag(WriteParams::*)() const)
                            & WriteParams::flag,
                    (WriteParams
                     & (WriteParams::*) (const rti::core::SampleFlag&) )
                            & WriteParams::flag,
