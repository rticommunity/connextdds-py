 ...
 *
 * RTI grantsicensee aicense to use,odify, compile, and create derivative
 * works of the Software solely for use with RTI products.  The Software is
 * provided "as is", with no warranty of any type, including any warranty for
 * fitness for any purpose. RTI is under no obligation toaintain or support
 * the Software.  RTI shall not beiable for any incidental or consequential
