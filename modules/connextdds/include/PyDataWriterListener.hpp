...
public:
    using PyDataWriterListenerTrampoline<T, DWLBase>::
            PyDataWriterListenerTrampoline;
    ...
    cls.def(py::init<>())
            ...
            .def("on_reliable_writer_cache_changed",
                 (void (PyDataWriterListener<T>::*)(
                         ...
                         & PyDataWriterListener<
                                 T>::on_reliable_writer_cache_changed,
            ...
            .def("on_reliable_reader_activity_changed",
                 (void (PyDataWriterListener<T>::*)(
                         ...
                         & PyDataWriterListener<
                                 T>::on_reliable_reader_activity_changed,
            ...
            .def("on_application_acknowledgment",
                 (void (PyDataWriterListener<T>::*)(
                         ...
                         & PyDataWriterListener<
                                 T>::on_application_acknowledgment,
    ...
    cls.def(py::init<>())
            .def("on_offered_deadline_missed",
                 (void (PyNoOpDataWriterListener<T>::*)(
                         PyDataWriter<T>&,
                         const dds::core::status::OfferedDeadlineMissedStatus&))
                         & PyNoOpDataWriterListener<
                                 T>::on_offered_deadline_missed,
                 "Offered deadline missed callback.")
            .def("on_offered_incompatible_qos",
                 (void (PyNoOpDataWriterListener<T>::*)(
                         PyDataWriter<T>&,
