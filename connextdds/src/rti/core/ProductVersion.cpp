...
template <> void init_class_defs(py::class_<ProductVersion> &cls) {
  cls.def(py::init<>(), "Creates the unknown product version.")
      .def_property_readonly("major_version", &ProductVersion::major_version,
                             "The major product version.")
      .def_property_readonly("minor_version", &ProductVersion::minor_version,
                             "The minor product version.")
      .def_property_readonly("release_version",
                             &ProductVersion::release_version,
                             "The release letter of the product version.")
      .def_property_readonly("revision_version",
                             &ProductVersion::revision_version,
                             "The revision number of product.")
      .def("__str__", &ProductVersion::to_string)
      .def_static("current", &ProductVersion::current,
                  "Create an instance representing the current version of RTI "
                  "Connext.")
      .def_static("unknown", &ProductVersion::unknown,
