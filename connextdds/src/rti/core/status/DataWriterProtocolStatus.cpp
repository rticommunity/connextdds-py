...
template <> void init_class_defs(py::class_<DataWriterProtocolStatus> &cls) {
  cls.def_property_readonly(
         "pushed_sample_count", &DataWriterProtocolStatus::pushed_sample_count,
         "The number of user samples pushed on write from a local "
         "DataWriter to a matching remote DataReader.")
      .def_property_readonly(
          "pushed_sample_bytes", &DataWriterProtocolStatus::pushed_sample_bytes,
      ...
      .def_property_readonly(
          ...
          "the send path.")
      .def_property_readonly(
          "send_window_size", &DataWriterProtocolStatus::send_window_size,
