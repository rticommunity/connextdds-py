...
template <> void init_class_defs(py::class_<DataWriterCacheStatus> &cls) {
  cls.def_property_readonly(
         "sample_count", &DataWriterCacheStatus::sample_count,
         "Number of samples in the DataWriter's queue, including "
         "unregister and dispose samples.")
      .def_property_readonly(
          "sample_count_peak", &DataWriterCacheStatus::sample_count_peak,
