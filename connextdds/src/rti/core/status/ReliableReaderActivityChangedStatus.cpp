...
void init_class_defs(py::class_<ReliableReaderActivityChangedStatus> &cls) {
  cls.def_property_readonly(
         "active_count", &ReliableReaderActivityChangedStatus::active_count,
...
template <>
void process_inits<ReliableReaderActivityChangedStatus>(py::module &m,
                                                        ClassInitList &l) {
  l.push_back([m]() mutable {
    return init_class<ReliableReaderActivityChangedStatus>(
        m, "ReliableReaderActivityChangedStatus");
  });
}
