...
template <> void init_class_defs(py::class_<SampleIdentity> &cls) {
  cls.def(py::init<>(), "Create a default SampleIdentity object.")
      .def(py::init<const Guid &, const SequenceNumber &>(),
           py::arg("writer_guid"), py::arg("sequence_number"),
