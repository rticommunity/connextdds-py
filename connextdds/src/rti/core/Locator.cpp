...
template <> void init_class_defs(py::class_<Locator> &cls) {
  cls.def(py::init<LocatorKind::type, uint32_t, std::vector<uint8_t>>(),
      ...
      .def_static("invalid", &Locator::Invalid, "Create an invalid Locator.")
      .doc() =
