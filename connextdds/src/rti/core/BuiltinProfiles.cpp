...
template <> void init_class_defs(py::class_<PyBuiltinProfiles> &cls) {
  cls.def_property_readonly_static(
      ...
      .def_property_readonly_static(
          ...
          [](py::object &) { return generic_strict_reliable_low_latency(); },
          "The profile name for reliable low-latency communication.")
      .def_property_readonly_static(
          "generic_participant_large_data",
          [](py::object &) { return generic_participant_large_data(); },
      ...
      .def_property_readonly_static(
          ...
          [](py::object &) { return generic_strict_reliable_large_data(); },
          "The profile name for sending large data with strict reliability.")
      .def_property_readonly_static(
          "generic_keep_last_reliable_large_data",
          [](py::object &) { return generic_keep_last_reliable_large_data(); },
