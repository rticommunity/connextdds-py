...
template <> void init_class_defs(py::class_<ChannelSettings> &cls) {
  cls.def(py::init<const std::vector<TransportMulticastSettings> &,
                   const std::string &, int32_t>(),
          py::arg("multicast_settings"), py::arg("filter_expression"),
          py::arg("priority"),
          "Creates an instance with the specified multicast settings, "
          "filter expression and priority.")
      .def_property(
          "multicast_settings",
          (std::vector<TransportMulticastSettings>(ChannelSettings::*)()
               const) &
              ChannelSettings::multicast_settings,
          (ChannelSettings &
           (ChannelSettings::*)(const std::vector<TransportMulticastSettings>
                                    &)) &
              ChannelSettings::multicast_settings,
      ...
      .def_property(
          ...
          (ChannelSettings & (ChannelSettings::*)(const std::string &)) &
              ChannelSettings::filter_expression,
