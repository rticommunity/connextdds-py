...
void init_class_defs(py::class_<ThreadSettings>& cls) {
    cls
        ...
        .def_property(
            "mask",
            (ThreadSettingsKindMask (ThreadSettings::*)() const) &ThreadSettings::mask,
            (ThreadSettings& (ThreadSettings::*)(ThreadSettingsKindMask)) &ThreadSettings::mask,
            "Get/set a copy of the thread settings mask."
        )
        .def_property(
            "priority",
            (int32_t (ThreadSettings::*)() const) &ThreadSettings::priority,
            (ThreadSettings& (ThreadSettings::*)(int32_t)) &ThreadSettings::priority,
            "Get/set a copy of the thread priority."
        )
        .def_property(
            "stack_size",
            (int32_t (ThreadSettings::*)() const) &ThreadSettings::stack_size,
            (ThreadSettings& (ThreadSettings::*)(int32_t)) &ThreadSettings::stack_size,
        ...
        .def_property(
            "cpu_rotation",
            (ThreadSettingsCpuRotationKind (ThreadSettings::*)() const) &ThreadSettings::cpu_rotation,
            (ThreadSettings& (ThreadSettings::*)(ThreadSettingsCpuRotationKind)) &ThreadSettings::cpu_rotation,
            "Get/set a copy of the thread settings mask."
        );
}
