...
template <> void init_class_defs(py::class_<DynamicDataMemberInfo> &cls) {
  cls.def(py::init<>(), "Create a DynamicDataMemberInfo object.")
      .def_property_readonly("index", &DynamicDataMemberInfo::member_index,
                             "The member index")
      .def_property_readonly(
          ...
          "The member name")
      .def_property_readonly("kind", &DynamicDataMemberInfo::member_kind,
      ...
      .def_property_readonly("element_kind",
