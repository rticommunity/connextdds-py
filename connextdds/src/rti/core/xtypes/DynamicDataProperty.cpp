...
template <> void init_class_defs(py::class_<DynamicDataProperty> &cls) {
  cls.def(py::init<>(), "Construct with default settings.")
      .def(py::init<int32_t, int32_t, int32_t, bool>(),
           py::arg("initial_buffer_size"), py::arg("max_buffer_size"),
           py::arg("max_buffer_size_increment"), py::arg("check_buffer_size"))
      .def_property("initial_buffer_size",
                    (int32_t(DynamicDataProperty::*)() const) &
                        DynamicDataProperty::buffer_initial_size,
                    (DynamicDataProperty & (DynamicDataProperty::*)(int32_t)) &
                        DynamicDataProperty::buffer_initial_size,
                    "Initial buffer size.")
      .def_property("max_buffer_size",
                    (int32_t(DynamicDataProperty::*)() const) &
                        DynamicDataProperty::buffer_max_size,
                    (DynamicDataProperty & (DynamicDataProperty::*)(int32_t)) &
                        DynamicDataProperty::buffer_max_size,
                    "Max buffer size.")
      .def_property("max_buffer_size_increment",
                    (int32_t(DynamicDataProperty::*)() const) &
                        DynamicDataProperty::buffer_max_size_increment,
                    (DynamicDataProperty & (DynamicDataProperty::*)(int32_t)) &
                        DynamicDataProperty::buffer_max_size_increment,
                    "Max buffer size.")
      .def_property("check_buffer_size",
