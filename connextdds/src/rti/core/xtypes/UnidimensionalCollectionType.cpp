...
void init_class_defs(
  ...
  cls.def_property_readonly("bounds", &UnidimensionalCollectionTypeImpl::bounds,
...
template <>
void process_inits<UnidimensionalCollectionTypeImpl>(py::module &m,
                                                     ClassInitList &l) {
  l.push_back([m]() mutable {
    return init_class<UnidimensionalCollectionTypeImpl, CollectionType>(
        m, "UnidimensionalCollectionType");
  });
}
