...
void pyrti::init_class_defs(py::class_<TransportUnicastSettings>& cls) {
    cls
        ...
        .def(
            ...
            >(),
            py::arg("transports"),
            py::arg("receive_port") = 0,
            "Creates the default policy."
        )
        .def_property(
            "transports",
            (std::vector<std::string> (TransportUnicastSettings::*)() const) &TransportUnicastSettings::transports,
            (TransportUnicastSettings& (TransportUnicastSettings::*)(const std::vector<std::string>&)) &TransportUnicastSettings::transports,
        ...
        .def_property(
            "receive_port",
            (int32_t (TransportUnicastSettings::*)() const) &TransportUnicastSettings::receive_port,
            (TransportUnicastSettings& (TransportUnicastSettings::*)(int32_t)) &TransportUnicastSettings::receive_port,
...
void pyrti::init_class_defs(py::class_<TransportUnicast>& cls) {
    cls
        ...
        .def(
            py::init<
                const std::vector<TransportUnicastSettings>&
            >(),
            py::arg("settings"),
        ...
        .def_property(
            "settings",
            (std::vector<TransportUnicastSettings> (TransportUnicast::*)() const) &TransportUnicast::settings,
