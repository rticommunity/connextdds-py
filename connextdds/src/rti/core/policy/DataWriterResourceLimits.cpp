...
template <> void init_class_defs(py::class_<DataWriterResourceLimits> &cls) {
  cls.def(py::init<>(), "Create a default DataWriterResourceLimits policy.")
      .def_property(
          ...
          (DataWriterResourceLimits & (DataWriterResourceLimits::*)(int32_t)) &
              DataWriterResourceLimits::initial_concurrent_blocking_threads,
      ...
      .def_property(
          ...
          (DataWriterResourceLimits & (DataWriterResourceLimits::*)(bool)) &
              DataWriterResourceLimits::replace_empty_instances,
      ...
      .def_property(
          ...
          (rti::core::AllocationSettings & (DataWriterResourceLimits::*)()) &
...
void process_inits<DataWriterResourceLimits>(py::module &m, ClassInitList &l) {
  init_dds_safe_enum<DataWriterResourceLimitsInstanceReplacementKind_def>(
      m, "DataWriterResourceLimitsInstaceReplacementKind", [](py::object &o) {
        py::enum_<DataWriterResourceLimitsInstanceReplacementKind::type>(o,
                                                                         "Enum")
            .value(
                "UNREGISTERED",
            ...
            .value(
                ...
                "acknowledged instance, where an alive instance is a "
                "registered, "
                "non-disposed instance. The least recently registered or "
                "written "
                "alive instance will be reclaimed.")
            .value(
                "DISPOSED",
                DataWriterResourceLimitsInstanceReplacementKind::type::DISPOSED,
                "Allows a DataWriter to reclaim disposed acknowledged "
                "instances."
                "\n\n"
                "When an unregistered, acknowledged instance is not available "
                "to "
                "reclaim, this kind allows a DataWriter to reclaim a disposed, "
                "acknowledged instance. The least recently disposed instance "
                "will "
                "be reclaimed.")
            .value(
                "ALIVE_THEN_DISPOSED",
                ...
                "reclaimable, then it tries reclaiming a disposed, "
                "acknowledged "
                "instance. The least recently used (i.e., registered, written, "
                "or "
            ...
            .value(
                ...
                "try reclaiming a disposed, acknowledged instance. If no "
                "instance "
                "is reclaimable, then it tries reclaiming an alive, "
                "acknowledged "
                "instance. The least recently used (i.e., disposed, "
                "registered, "
            ...
            .value(
                ...
                "acknowledged instance. If both instance kinds are available "
                "to "
