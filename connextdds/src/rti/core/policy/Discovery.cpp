...
template <> void process_inits<Discovery>(py::module &m, ClassInitList &l) {
  l.push_back([m]() mutable { return init_class<Discovery>(m, "Discovery"); });
}
