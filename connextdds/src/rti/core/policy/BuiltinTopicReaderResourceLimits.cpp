...
template <>
void init_class_defs(py::class_<BuiltinTopicReaderResourceLimits> &cls) {
  cls.def(py::init<>(), "Create a policy with default settings.")
      .def_property("initial_samples",
      ...
      .def_property(
          ...
          (bool (BuiltinTopicReaderResourceLimits::*)() const) &
              BuiltinTopicReaderResourceLimits::disable_fragmentation_support,
          (BuiltinTopicReaderResourceLimits &
           (BuiltinTopicReaderResourceLimits::*)(bool)) &
              BuiltinTopicReaderResourceLimits::disable_fragmentation_support,
...
template <>
void process_inits<BuiltinTopicReaderResourceLimits>(py::module &m,
                                                     ClassInitList &l) {
  l.push_back([m]() mutable {
    return init_class<BuiltinTopicReaderResourceLimits>(
        m, "BuiltinTopicReaderResourceLimits");
  });
}
