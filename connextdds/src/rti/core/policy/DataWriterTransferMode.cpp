...
void init_class_defs(py::class_<DataWriterShmemRefTransferModeSettings>& cls) {
    cls
        ...
        .def_property(
            ...
            (bool (rti::core::DataWriterShmemRefTransferModeSettings::*)() const) &rti::core::DataWriterShmemRefTransferModeSettings::enable_data_consistency_check,
            (rti::core::DataWriterShmemRefTransferModeSettings& (rti::core::DataWriterShmemRefTransferModeSettings::*)(bool)) &rti::core::DataWriterShmemRefTransferModeSettings::enable_data_consistency_check,
...
void init_class_defs(py::class_<DataWriterTransferMode>& cls) {
    cls
        ...
        .def_property(
            "shmem_ref_settings",
            (rti::core::DataWriterShmemRefTransferModeSettings& (DataWriterTransferMode::*)()) &DataWriterTransferMode::shmem_ref_settings,
            (DataWriterTransferMode& (DataWriterTransferMode::*)(const rti::core::DataWriterShmemRefTransferModeSettings&)) &DataWriterTransferMode::shmem_ref_settings,
