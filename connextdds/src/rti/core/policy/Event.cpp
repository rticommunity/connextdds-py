...
template <> void init_class_defs(py::class_<Event> &cls) {
  cls.def(py::init<>(), "Creates the default policy.")
      .def(py::init<const rti::core::ThreadSettings &, int32_t, int32_t>(),
           py::arg("thread"), py::arg("initial_count"), py::arg("max_count"),
      ...
      .def_property("initial_count",
                    ...
                    "Event thread QoS.")
      .def_property("max_count", (int32_t(Event::*)() const) & Event::max_count,
...
template <> void process_inits<Event>(py::module &m, ClassInitList &l) {
