...
template <> void init_class_defs(py::class_<TransportMulticast> &cls) {
  cls.def(py::init<>(), "Creates the default policy.")
      .def(py::init<const std::vector<TransportMulticastSettings> &,
                    TransportMulticastKind>(),
           py::arg("value"), py::arg("kind"),
           "Creates an instance with the speicfied multicast settings.")
      .def_property(
          "settings",
          (std::vector<TransportMulticastSettings>(TransportMulticast::*)()
               const) &
              TransportMulticast::settings,
          (TransportMulticast &
           (TransportMulticast::*)(const std::vector<TransportMulticastSettings>
                                       &)) &
              TransportMulticast::settings,
...
void init_class_defs(py::class_<TransportMulticastMappingFunction> &cls) {
  cls.def(py::init<const std::string &, const std::string &>(), py::arg("dll"),
          py::arg("function_name"), "Create a mapping function instance.")
      .def_property(
          "dll",
          ...
          (TransportMulticastMappingFunction &
           (TransportMulticastMappingFunction::*)(const std::string &)) &
              TransportMulticastMappingFunction::dll,
...
template <> void init_class_defs(py::class_<MulticastMapping> &cls) {
  cls.def(py::init<>(), "Creates the default mapping")
      .def(py::init<const std::string &, const std::string &,
                    const TransportMulticastMappingFunction &>(),
           py::arg("addresses"), py::arg("topic_expression"),
           py::arg("mapping_function"),
           "Creates a mapping with the specified parameters")
      .def_property(
          "addresses",
          (rti::core::optional_value<std::string>(MulticastMapping::*)()
               const) &
              MulticastMapping::addresses,
          (MulticastMapping & (MulticastMapping::*)(const std::string &)) &
              MulticastMapping::addresses,
      ...
      .def_property(
          "mapping_function",
          (TransportMulticastMappingFunction & (MulticastMapping::*)()) &
...
template <> void init_class_defs(py::class_<TransportMulticastMapping> &cls) {
  cls.def(py::init<>(), "Creates the default policy.")
      ...
      .def_property(
          "mappings",
          (std::vector<MulticastMapping>(TransportMulticastMapping::*)()
               const) &
              TransportMulticastMapping::mappings,
          (TransportMulticastMapping &
           (TransportMulticastMapping::*)(const std::vector<MulticastMapping>
                                              &)) &
              TransportMulticastMapping::mappings,
...
void process_inits<TransportMulticast>(py::module &m, ClassInitList &l) {
  init_dds_safe_enum<TransportMulticastKind_def>(
      m, "TransportMulticastKind", [](py::object &o) {
        py::enum_<TransportMulticastKind::type>(o, "Enum")
            .value("AUTOMATIC", TransportMulticastKind::type::AUTOMATIC,
                   "Selects the multicast address automatically."
                   "\n\n"
                   "NOTE: This setting is required when using the "
                   "TransportMulticastMapping.")
            .value("UNICAST", TransportMulticastKind::type::UNICAST,
  ...
  l.push_back([m]() mutable {
    return init_class<TransportMulticastMappingFunction>(
        m, "TransportMulticastMappingFunction");
  });
  ...
  l.push_back([m]() mutable {
    return init_class<TransportMulticastMapping>(m,
                                                 "TransportMulticastMapping");
  });
}
