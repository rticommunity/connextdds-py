...
void init_class_defs(py::class_<DiscoveryConfigBuiltinPluginKindMask> &cls) {
  cls.def_static("all", &DiscoveryConfigBuiltinPluginKindMask::all,
                 "Create a mask with all bits set.")
      .def_static("none", &DiscoveryConfigBuiltinPluginKindMask::none,
                  "Create a mask with no bits set.")
      .def_static(
          "sdp", &DiscoveryConfigBuiltinPluginKindMask::SDP,
...
template <> void init_class_defs(py::class_<DiscoveryConfig> &cls) {
  cls.def(py::init<>(), "Creates the default policy.")
      .def_property("participant_liveliness_lease_duration",
      ...
      .def_property("participant_liveliness_assert_period",
                    (dds::core::Duration(DiscoveryConfig::*)() const) &
      ...
      .def_property(
          ...
          (DiscoveryConfig & (DiscoveryConfig::*)(RemoteParticipantPurgeKind)) &
              DiscoveryConfig::remote_participant_purge_kind,
      ...
      .def_property("max_liveliness_loss_detection_period",
                    (dds::core::Duration(DiscoveryConfig::*)() const) &
      ...
      .def_property(
          ...
          (dds::core::policy::WriterDataLifecycle & (DiscoveryConfig::*)()) &
              DiscoveryConfig::publication_writer_data_lifecycle,
          (DiscoveryConfig &
           (DiscoveryConfig::*)(const dds::core::policy::WriterDataLifecycle
                                    &)) &
              DiscoveryConfig::publication_writer_data_lifecycle,
      ...
      .def_property(
          ...
          (DiscoveryConfigBuiltinPluginKindMask(DiscoveryConfig::*)() const) &
      ...
      .def_property(
          ...
          (dds::core::policy::ReliabilityKind(DiscoveryConfig::*)() const) &
              DiscoveryConfig::participant_message_reader_reliability_kind,
          (DiscoveryConfig &
           (DiscoveryConfig::*)(dds::core::policy::ReliabilityKind)) &
              DiscoveryConfig::participant_message_reader_reliability_kind,
      ...
      .def_property(
          ...
          (DiscoveryConfig & (DiscoveryConfig::*)(const PublishMode &)) &
              DiscoveryConfig::publication_writer_publish_mode,
      ...
      .def_property("service_request_writer",
                    (RtpsReliableWriterProtocol & (DiscoveryConfig::*)()) &
...
void process_inits<DiscoveryConfig>(py::module &m, ClassInitList &l) {
  init_dds_safe_enum<RemoteParticipantPurgeKind_def>(
      m, "RemoteParticipantPurgeKind", [](py::object &o) {
        py::enum_<RemoteParticipantPurgeKind::type>(o, "Enum")
            .value(
                ...
                "lost, however, the local participant will remove all records "
                "of "
                "the remote participant and its contained endpoints, and no "
                "further data communication with them will occur until and "
                "unless "
                ...
                "DiscoveryConfig.participant_liveliness_lease_duration QoS "
                "field. "
                ...
                "DiscoveryConfig.participant_liveliness_assert_period) over "
                "the "
                "Simple Discovery Protocol.")
            .value(
                "NO_PURGE", RemoteParticipantPurgeKind::type::NO_PURGE,
                "Never \"forget\" a remote participant with which discovery "
                "communication has been lost."
                "\n\n"
                "If a participant with this behavior loses discovery "
                "communication "
                "with a remote participant, it will nevertheless remember that "
                "remote participant and its endpoints and continue attempting "
                "to "
                "communicate with them indefinitely."
                "\n\n"
                "This value has consequences for a participant's resource "
                "usage. "
                "If discovery communication with a remote participant is lost, "
                "but the same participant is later rediscovered, any relevant "
                "records that remain in the database will be reused. However, "
                "if "
  ...
  l.push_back([m]() mutable {
    auto cls = init_mask_type<DiscoveryConfigBuiltinPluginKindMask, uint64_t>(
        m, "DiscoveryConfigBuiltinPluginKindMask",
