...
template <> void init_class_defs(py::class_<RtpsReliableWriterProtocol> &cls) {
  cls.def(py::init<>(), "Create a default RtpsReliableWriterProtocol policy.")
      ...
      .def_property(
          ...
          (RtpsReliableWriterProtocol &
           (RtpsReliableWriterProtocol::*)(const dds::core::Duration &)) &
              RtpsReliableWriterProtocol::heartbeat_period,
      ...
      .def_property(
          ...
          (RtpsReliableWriterProtocol & (RtpsReliableWriterProtocol::*)(bool)) &
              RtpsReliableWriterProtocol::inactivate_nonprogressing_readers,
          "Whether to treat remote readers as inactive when their NACKs do "
          "not progress.")
      .def_property("heartbeats_per_max_samples",
                    (int32_t(RtpsReliableWriterProtocol::*)() const) &
      ...
      .def_property("min_send_window_size",
                    (int32_t(RtpsReliableWriterProtocol::*)() const) &
      ...
      .def_property("max_send_window_size",
                    (int32_t(RtpsReliableWriterProtocol::*)() const) &
...
template <>
void process_inits<RtpsReliableWriterProtocol>(py::module &m,
                                               ClassInitList &l) {
  l.push_back([m]() mutable {
    return init_class<RtpsReliableWriterProtocol>(m,
                                                  "RtpsReliableWriterProtocol");
  });
}
