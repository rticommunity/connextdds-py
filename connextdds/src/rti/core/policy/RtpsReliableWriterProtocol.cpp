...
template<>
void init_class_defs(py::class_<RtpsReliableWriterProtocol>& cls)
{
    cls.def(py::init<>(), "Create a default RtpsReliableWriterProtocol policy.")
            .def_property(
                    "low_watermark",
                    (int32_t(RtpsReliableWriterProtocol::*)() const)
                            & RtpsReliableWriterProtocol::low_watermark,
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (int32_t))
                            & RtpsReliableWriterProtocol::low_watermark,
                    "When the number of unacknowledged samples in the current "
                    "send "
                    "window of a reliable writer meets or falls below this "
                    "threshold, "
                    "the StatusMask.reliable_writer_cache_changed is "
                    "considered to "
                    "have changed.")
            .def_property(
                    "high_watermark",
                    ...
                    "When the number of unacknowledged samples in the current "
                    "send "
                    "window of a reliable writer meets or exceeds this "
                    "threshold, "
                    "StatusMask.reliable_writer_cache_changed is considered to "
                    "have "
                    "changed.")
            .def_property(
                    "heartbeat_period",
                    (dds::core::Duration(RtpsReliableWriterProtocol::*)() const)
                            & RtpsReliableWriterProtocol::heartbeat_period,
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (const dds::core::
                                                                Duration&) )
                            & RtpsReliableWriterProtocol::heartbeat_period,
            ...
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (const dds::core::
                                                                Duration&) )
                            & RtpsReliableWriterProtocol::fast_heartbeat_period,
                    "An alternative heartbeat period used when a reliable "
                    "writer "
            ...
            .def_property(
                    ...
                    "An alternative heartbeat period used when a reliable "
                    "reader "
                    "joins late and needs to be caught up on cached samples of "
                    "a "
                    "reliable writer more quickly than the normal heartbeat "
                    "rate."
                    "\n\n"
                    "This property's getter returns a deep copy.")
            .def_property(
                    "virtual_heartbeat_period",
                    (dds::core::Duration(RtpsReliableWriterProtocol::*)())
                            & RtpsReliableWriterProtocol::
                                    virtual_heartbeat_period,
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (const dds::core::
                    ...
                    "heartbeats inform the reliable reader about the range of "
                    "samples "
            ...
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (int32_t))
                            & RtpsReliableWriterProtocol::
                                    samples_per_virtual_heartbeat,
                    "The number of samples that a reliable writer has to "
                    "publish "
            ...
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (int32_t))
                            & RtpsReliableWriterProtocol::max_heartbeat_retries,
                    "The maximum number of periodic heartbeat retries before "
                    "marking "
            ...
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (bool) )
                            & RtpsReliableWriterProtocol::
                                    inactivate_nonprogressing_readers,
                    "Whether to treat remote readers as inactive when their "
                    "NACKs do "
                    "not progress.")
            .def_property(
            ...
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (const dds::core::
                            ...
                            & RtpsReliableWriterProtocol::
                                    nack_suppression_duration,
                    "The duration for ignoring consecutive NACKs that may "
                    "trigger "
                    "redundant repairs."
                    "\n\n"
                    "This property's getter returns a deep copy.")
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (int32_t))
                            & RtpsReliableWriterProtocol::
                                    max_bytes_per_nack_response,
                    "The maximum total message size when resending dropped "
                    "samples.")
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (const dds::core::
                            ...
                            & RtpsReliableWriterProtocol::
                                    disable_positive_acks_min_sample_keep_duration,
                    "The minimum duration a sample is queued for ACK-disabled "
                    "readers."
                    "\n\n"
                    "This property's getter returns a deep copy.")
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (const dds::core::
                            ...
                            & RtpsReliableWriterProtocol::
                                    disable_positive_acks_max_sample_keep_duration,
                    "The maximum duration a sample is queued for ACK-disabled "
                    "readers."
                    "\n\n"
                    "This property's getter returns a deep copy.")
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (bool) )
                            & RtpsReliableWriterProtocol::
                                    disable_positive_acks_enable_adaptive_sample_keep_duration,
                    "Enables dynamic adjustment of sample keep duration in "
                    "response "
                    "to congestion.")
            .def_property(
                    "disable_positive_acks_decrease_sample_keep_duration_"
                    "factor",
                    (int32_t(RtpsReliableWriterProtocol::*)() const)
                            & RtpsReliableWriterProtocol::
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (int32_t))
                            & RtpsReliableWriterProtocol::
                                    disable_positive_acks_decrease_sample_keep_duration_factor,
                    "Controls rate of contraction of dynamic sample keep "
                    "duration.")
            .def_property(
                    "disable_positive_acks_increase_sample_keep_duration_"
                    "factor",
                    (int32_t(RtpsReliableWriterProtocol::*)() const)
                            & RtpsReliableWriterProtocol::
            ...
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (int32_t))
                            & RtpsReliableWriterProtocol::
                                    send_window_increase_factor,
                    "Increases send window size by this percentage when "
                    "reacting "
            ...
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (int32_t))
                            & RtpsReliableWriterProtocol::
                                    send_window_decrease_factor,
                    "Decreases send window size by this percentage when "
                    "reacting "
                    "dynamically to network conditions.")
            .def_property(
                    ...
                    (RtpsReliableWriterProtocol
                     & (RtpsReliableWriterProtocol::*) (bool) )
                            & RtpsReliableWriterProtocol::
                                    enable_multicast_periodic_heartbeat,
                    "Whether periodic heartbeat messages are sent over "
                    "multicast.")
            .def_property(
...
template<>
void process_inits<RtpsReliableWriterProtocol>(py::module& m, ClassInitList& l)
{
    l.push_back([m]() mutable {
        return init_class<RtpsReliableWriterProtocol>(
                m,
                "RtpsReliableWriterProtocol");
    });
}
