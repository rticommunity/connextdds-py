...
void init_class_defs(py::class_<TransportBuiltin>& cls) {
    cls
        ...
        .def_property(
            "mask",
            (TransportBuiltinMask (TransportBuiltin::*)() const) &TransportBuiltin::mask,
            (TransportBuiltin& (TransportBuiltin::*)(TransportBuiltinMask)) &TransportBuiltin::mask,
