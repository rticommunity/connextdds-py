...
template <> void init_class_defs(py::class_<TopicQueryDispatch> &cls) {
  cls.def(py::init<>(), "Creates the default policy.")
      .def(py::init<bool, const dds::core::Duration &, int32_t>(),
           py::arg("enable"), py::arg("publication_period"),
      ...
      .def_property("publication_period",
      ...
      .def_property("samples_per_period",
