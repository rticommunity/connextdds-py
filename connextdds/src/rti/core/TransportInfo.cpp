...
void init_class_defs(py::class_<TransportInfo>& cls) {
    cls
        ...
        .def_property(
            "class_id",
            (TransportClassId (TransportInfo::*)() const) &TransportInfo::class_id,
            (TransportInfo& (TransportInfo::*)(const TransportClassId::type&)) &TransportInfo::class_id,
        ...
        .def_property(
            ...
            (TransportInfo& (TransportInfo::*)(int32_t)) &TransportInfo::message_size_max,
...
void process_inits<TransportInfo>(py::module& m, ClassInitList& l) {
    init_dds_safe_enum<TransportClassId_def>(m, "TransportClassId",
        [](py::object& o) {
            py::enum_<TransportClassId::type>(o, "Enum")
                .value(
                    "INVALID",
                    TransportClassId::type::INVALID,
                    "Invalid."
                )
                .value(
                    "ANY",
                    TransportClassId::type::ANY,
                    "Any."
                )
                .value(
                    "UDPv4",
                    TransportClassId::type::UDPv4,
                    "UDPv4."
                )
                .value(
                    "SHMEM",
                    TransportClassId::type::SHMEM,
                    "Shared memory."
                )
                .value(
                    "SHMEM_510",
                ...
                .value(
                    "DTLS",
                    TransportClassId::type::DTLS,
                    "DTLS."
                )
                .value(
                    "WAN",
                    TransportClassId::type::WAN,
                    "WAN."
                )
                .value(
                    "TCPV4_LAN",
