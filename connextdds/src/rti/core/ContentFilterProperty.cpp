...
template <> void init_class_defs(py::class_<ContentFilterProperty> &cls) {
  cls.def_property_readonly(
      ...
      .def_property_readonly("content_filter_topic_name",
                             &ContentFilterProperty::expression_parameters,
                             "The ContentFilteredTopic filter parameters.")
      .def_property_readonly(
          "filter_class_name",
          [](const ContentFilterProperty &c) { return c.filter_class_name(); },
          "Identifies the filter class this filter belongs to.")
      .def_property_readonly(
          "filter_expression",
          [](const ContentFilterProperty &c) { return c.filter_expression(); },
          "The filter expression.")
      .def_property_readonly(
          "related_topic_name",
          [](const ContentFilterProperty &c) { return c.related_topic_name(); },
