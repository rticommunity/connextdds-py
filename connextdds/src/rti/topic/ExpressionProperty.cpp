...
void init_class_defs(py::class_<ExpressionProperty>& cls)
{
    cls.def(py::init<>(),
            ...
            .def(py::init<bool, bool>(),
                 ...
                 "Create an ExpressionProperty with the provided "
                 "key_only_filter, "
            ...
            .def_property(
                    ...
                    (ExpressionProperty & (ExpressionProperty::*) (bool) )
                            & ExpressionProperty::
                                    writer_side_filter_optimization,
                    "The value for writer_side_filter_optimization, indicating "
                    "if the "
                    "filter implementation can cache the filtering result for "
                    "the "
                    "provided expression.")
