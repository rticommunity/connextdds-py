...
void pyrti::init_class_defs(py::class_<ExpressionProperty>& cls) {
    cls
        ...
        .def_property(
            "key_only_filter",
            (bool (ExpressionProperty::*)() const) &ExpressionProperty::key_only_filter,
            (ExpressionProperty& (ExpressionProperty::*)(bool)) &ExpressionProperty::key_only_filter,
        ...
        .def_property(
            ...
            (bool (ExpressionProperty::*)() const) &ExpressionProperty::writer_side_filter_optimization,
            (ExpressionProperty& (ExpressionProperty::*)(bool)) &ExpressionProperty::writer_side_filter_optimization,
