...
void init_dds_typed_topic_template(
    py::class_<PyTopic<rti::topic::ServiceRequest>,
               PyITopicDescription<rti::topic::ServiceRequest>, PyIAnyTopic>
        &cls) {
  init_dds_typed_topic_base_template(cls);
}

template <> void init_class_defs(py::class_<ServiceRequest> &cls) {
  cls.def_property_readonly("service_id", &ServiceRequest::service_id,
                            "The service id of the request.")
      .def_property_readonly("instance_id", &ServiceRequest::instance_id,
                             "Get the instance id of the request.")
      .def_property_readonly("request_body", &ServiceRequest::request_body,
                             "Get the request body of the request.")
      .def_property_readonly_static(
          "topic_name",
          [](py::object &) { return rti::topic::service_request_topic_name(); },
...
void process_inits<ServiceRequest>(py::module &m, ClassInitList &l) {
  init_dds_safe_enum<rti::core::ServiceRequestId_def>(
      m, "ServiceRequestId", [](py::object &o) {
        py::enum_<rti::core::ServiceRequestId::type>(o, "Enum")
            .value("UNKNOWN", rti::core::ServiceRequestId::type::UNKNOWN,
                   "An unknown service.")
            .value("TOPIC_QUERY",
