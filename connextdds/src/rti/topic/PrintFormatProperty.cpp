...
template <> void init_class_defs(py::class_<PrintFormatProperty> &cls) {
  cls.def(
         py::init<PrintFormatKind, bool, bool, bool>(),
         py::arg_v("kind", PrintFormatKind::DEFAULT, "PrintFormatKind.DEFAULT"),
         py::arg("is_pretty_print") = true, py::arg("is_enum_as_int") = false,
      ...
      .def_property(
          ...
          (PrintFormatProperty & (PrintFormatProperty::*)(PrintFormatKind)) &
              PrintFormatProperty::kind,
          "Get/set the kind value.")
      .def_property("pretty_print",
...
void process_inits<PrintFormatProperty>(py::module &m, ClassInitList &l) {
  init_dds_safe_enum<PrintFormatKind_def>(
      m, "PrintFormatKind", [](py::object &o) {
        py::enum_<PrintFormatKind::type>(o, "Enum")
            .value("DEFAULT", PrintFormatKind::type::DEFAULT,
                   "Use a default format specific to RTI Connext to represent "
                   "the data when converting a data sample to a string.")
            .value("XML", PrintFormatKind::type::XML,
                   "Use an XML format to represent the data when converting a "
                   "data sample to a string.")
            .value("JSON", PrintFormatKind::type::JSON,
                   "Use an JSON format to represent the data when converting a "
                   "data sample to a string.")
            .export_values();
      });
