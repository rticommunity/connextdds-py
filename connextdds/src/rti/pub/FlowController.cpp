...
void init_class_defs(py::class_<FlowController>& cls) {
    cls
        ...
        .def_property_readonly(
            "property",
            (FlowControllerProperty (FlowController::*)() const) &FlowController::property,
...
void init_class_defs(py::class_<FlowControllerProperty>& cls) {
    cls
        ...
        .def(
            ...
            py::arg_v("token_bucket", FlowControllerTokenBucketProperty(), "FlowControllerTokenBucketProperty()"),
            "Creates a FlowControllerProperty with the specified scheduling "
            "policy and token-bucket configuration."
        )
        .def_property(
            "scheduling_policy",
            (FlowControllerSchedulingPolicy::type (FlowControllerProperty::*)() const) &FlowControllerProperty::scheduling_policy,
            (FlowControllerProperty& (FlowControllerProperty::*)(FlowControllerSchedulingPolicy::type)) &FlowControllerProperty::scheduling_policy,
            "The scheduling policy."
        )
        .def_property(
            "token_bucket",
            (FlowControllerTokenBucketProperty& (FlowControllerProperty::*)()) &FlowControllerProperty::token_bucket,
            [](FlowControllerProperty& fcp, FlowControllerTokenBucketProperty& prop) {
    ...
    cls
        .def(
            py::init<
                ...
                int32_t
            >(),
            py::arg_v("max_tokens", dds::core::LENGTH_UNLIMITED, "LENGTH_UNLIMITED"),
            py::arg_v("tokens_added_per_period", dds::core::LENGTH_UNLIMITED, "LENGTH_UNLIMITED"),
            py::arg("tokens_leaked_per_period") = 0,
            py::arg_v("period", dds::core::Duration(1, 0), "Duration(1, 0)"),
            py::arg_v("bytes_per_token", dds::core::LENGTH_UNLIMITED, "LENGTH_UNLIMITED"),
            "Initializes the properties."
        )
        .def_property(
            "max_tokens",
            (int32_t (FlowControllerTokenBucketProperty::*)() const) &FlowControllerTokenBucketProperty::max_tokens,
            (FlowControllerTokenBucketProperty& (FlowControllerTokenBucketProperty::*)(int32_t)) &FlowControllerTokenBucketProperty::max_tokens,
            "The maximum number of tokens that can accumulate in the token "
            "bucket."
        )
        .def_property(
            "tokens_added_per_period",
            (int32_t (FlowControllerTokenBucketProperty::*)() const) &FlowControllerTokenBucketProperty::tokens_added_per_period,
            (FlowControllerTokenBucketProperty& (FlowControllerTokenBucketProperty::*)(int32_t)) &FlowControllerTokenBucketProperty::tokens_added_per_period,
            "The number of tokens added to the token bucket per specified "
            "period."
        )
        .def_property(
            "tokens_leaked_per_period",
            (int32_t (FlowControllerTokenBucketProperty::*)() const) &FlowControllerTokenBucketProperty::tokens_leaked_per_period,
            (FlowControllerTokenBucketProperty& (FlowControllerTokenBucketProperty::*)(int32_t)) &FlowControllerTokenBucketProperty::tokens_leaked_per_period,
            "The number of tokens removed from the token bucket per specified "
            "period."
        )
        .def_property(
            "period",
            (dds::core::Duration (FlowControllerTokenBucketProperty::*)() const) &FlowControllerTokenBucketProperty::period,
            (FlowControllerTokenBucketProperty& (FlowControllerTokenBucketProperty::*)(const dds::core::Duration&)) &FlowControllerTokenBucketProperty::period,
            "The period for adding tokens to and removing tokens from the "
            "bucket."
        )
        .def_property(
            "bytes_per_token",
            (int32_t (FlowControllerTokenBucketProperty::*)() const) &FlowControllerTokenBucketProperty::bytes_per_token,
            (FlowControllerTokenBucketProperty& (FlowControllerTokenBucketProperty::*)(int32_t)) &FlowControllerTokenBucketProperty::bytes_per_token,
