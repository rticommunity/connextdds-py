...
void init_class_defs(py::class_<DataStateEx>& cls) {
    cls
        ...
        .def_property(
            "stream_kind",
            (const StreamKind& (DataStateEx::*)() const) &DataStateEx::stream_kind,
            (void (DataStateEx::*)(const StreamKind&)) &DataStateEx::stream_kind,
            "The StreamKind."
        )
        .def_property(
            "sample_state",
            (const dds::sub::status::SampleState& (DataStateEx::*)() const) &DataStateEx::sample_state,
            (void (DataStateEx::*)(const dds::sub::status::SampleState&)) &DataStateEx::sample_state,
            "The SampleState of the DataStateEx."
        )
        .def_property(
            "instance_state",
            (const dds::sub::status::InstanceState& (DataStateEx::*)() const) &DataStateEx::instance_state,
            (void (DataStateEx::*)(const dds::sub::status::InstanceState&)) &DataStateEx::instance_state,
            "The InstanceState of the DataStateEx."
        )
        .def_property(
            "view_state",
            (const dds::sub::status::ViewState& (DataStateEx::*)() const) &DataStateEx::view_state,
            (void (DataStateEx::*)(const dds::sub::status::ViewState&)) &DataStateEx::view_state,
        ...
        .def(
            "__lshift__",
            (DataStateEx& (DataStateEx::*)(const StreamKind&)) &DataStateEx::operator<<,
            py::is_operator(),
            "Set the StreamKind for the DataStateEx."
        )
        .def(
            "__lshift__",
            (dds::sub::status::DataState& (DataStateEx::*)(const dds::sub::status::SampleState&)) &DataStateEx::operator<<,
            py::is_operator(),
            "Set the SampleState for the DataState."
        )
        .def(
            "__lshift__",
            (dds::sub::status::DataState& (DataStateEx::*)(const dds::sub::status::ViewState&)) &DataStateEx::operator<<,
            py::is_operator(),
            "Set the ViewState for the DataState."
        )
        .def(
            "__lshift__",
            (dds::sub::status::DataState& (DataStateEx::*)(const dds::sub::status::InstanceState&)) &DataStateEx::operator<<,
            py::is_operator(),
