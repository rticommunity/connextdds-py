...
template <> void init_class_defs(py::class_<QosProvider> &cls) {
  cls.def(py::init<const std::string &, const std::string &>(), py::arg("uri"),
          py::arg("profile"),
          "Creates a QosProvider fetching QoS configuration from the specified "
          "URI.")
      .def(py::init<const std::string>(), py::arg("uri"),
           "Create a QosProvider fetching QoS configuration from the specified "
           "URI.")
      .def_property_readonly("participant_qos",
      ...
      .def_property_readonly(
          "topic_qos", (TopicQos(QosProvider::*)()) & QosProvider::topic_qos,
      ...
      .def("get_topic_qos_profile",
           ...
           py::arg("profile_name"), "Get the TopicQos from a qos profile.")
      .def_property_readonly("subscriber_qos",
                             (SubscriberQos(QosProvider::*)()) &
                                 QosProvider::subscriber_qos,
                             "Get a copy of the SubscriberQos currently "
                             "associated with this QosProvider.")
      .def("get_subscriber_qos_profile",
           (SubscriberQos(QosProvider::*)(const std::string &)) &
               QosProvider::subscriber_qos,
           py::arg("profile"), "Get the SubscriberQos from a qos profile.")
      .def_property_readonly("datareader_qos",
                             (DataReaderQos(QosProvider::*)()) &
                                 QosProvider::datareader_qos,
                             "Get a copy of the DataReaderQos currently "
                             "associated with the QosProvider.")
      .def("get_datareader_qos_profile",
           (DataReaderQos(QosProvider::*)(const std::string &)) &
               QosProvider::datareader_qos,
           py::arg("profile"), "Get the DataReaderQos from a qos profile.")
      .def_property_readonly("publisher_qos",
                             (PublisherQos(QosProvider::*)()) &
                                 QosProvider::publisher_qos,
                             "Get a copy of the PublisherQos currently "
                             "associated with the QosProvider.")
      .def("get_publisher_qos_profile",
           (PublisherQos(QosProvider::*)(const std::string &)) &
               QosProvider::publisher_qos,
           py::arg("profile"), "Get the PublisherQos from a qos profile.")
      .def_property_readonly("datawriter_qos",
                             (DataWriterQos(QosProvider::*)()) &
                                 QosProvider::datawriter_qos,
                             "Get a copy of the DataWriterQos currently "
                             "associated with the QosProvider.")
      .def("get_datawriter_qos_profile",
           (DataWriterQos(QosProvider::*)(const std::string &)) &
               QosProvider::datawriter_qos,
           py::arg("profile"), "Get the DataWriterQos from a qos profile.")
      .def_property_static(
      ...
      .def(
          ...
          py::arg("profile_name"), py::arg("topic_name"),
      ...
      .def_property(
          ...
          "The default library associated with this QosProvider (None if not "
          "set).")
      .def_property(
          "default_profile",
          ...
          "The default profile associated with this QosProvider (None if not "
          "set).")
      .def_property_readonly(
          ...
          "The library of the default profile associated with this QosProvider "
          "(None if not set).")
      .def_property_readonly(
          "qos_profile_libraries",
          [](const QosProvider &qp) { return qp->qos_profile_libraries(); },
      ...
      .def(
          ...
          py::arg("library"),
          "Get a list of the QoS profiles loaded the specified library of the "
          "QosProvider.")
      ...
      .def(
          "type",
          [](const QosProvider &qp, const std::string &type_lib_name,
      ...
      .def(
          ...
          py::arg("name"), "Get a DynamicType from the QosProvider.")
#endif
      .def_property_readonly(
          "type_libraries",
      ...
      .def(
          "load_profiles", [](QosProvider &qp) { qp->load_profiles(); },
          "Load the XML QoS profiles from this QosProvider.")
      .def(
          "reload_profiles", [](QosProvider &qp) { qp->reload_profiles(); },
          "Reload the XML QoS profiles from this QosProvider.")
      .def(
          "unload_profiles", [](QosProvider &qp) { qp->unload_profiles(); },
          "Unload the XML QoS profiles from this QosProvider.")
      .def(
          "create_participant_from_config",
          [](QosProvider &qp, const std::string &config,
             const rti::domain::DomainParticipantConfigParams &params) {
            return PyDomainParticipant(
                qp->create_participant_from_config(config, params));
          },
          py::arg("config"),
          py::arg_v("params", rti::domain::DomainParticipantConfigParams(),
      ...
      .def_static("default", &QosProvider::Default,
                  "Get the default QosProvider.")
      .def_static("reset_default", &QosProvider::reset_default,
                  "Reset the settings of the default QosProvider.")
      .def(py::self == py::self, "Test for equality.")
      .def(py::self != py::self, "Test for inequality.");
}

template <> void process_inits<QosProvider>(py::module &m, ClassInitList &l) {
  l.push_back(
      [m]() mutable { return init_class<QosProvider>(m, "QosProvider"); });
}
