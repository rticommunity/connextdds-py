...
void init_class_defs(py::class_<PyGuardCondition, PyICondition> &cls) {
  cls.def(py::init<>(), "Create a GuardCondition in an untriggered state.")
      .def(py::init([](PyICondition &c) {
           ...
           py::arg("condition"), "Create a GuardCondition from a Condition.")
      .def(
          "set_handler",
          ...
          py::arg("func"), "Set a handler function for this GuardCondition.")
      .def("reset_handler", &PyGuardCondition::reset_handler,
           "Resets the handler for this GuardCondition.")
      .def_property("trigger_value",
...
template <>
void process_inits<dds::core::cond::GuardCondition>(py::module &m,
                                                    ClassInitList &l) {
