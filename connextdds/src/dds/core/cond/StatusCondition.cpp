...
void init_class_defs(py::class_<PyStatusCondition, PyICondition> &cls) {
  cls.def(py::init(
              [](PyIEntity &e) { return PyStatusCondition(e.get_entity()); }),
          py::arg("entity"), py::keep_alive<1, 2>(),
      ...
      .def(py::init([](PyICondition &c) {
           ...
           py::arg("condition"), "Downcast a Condition to a StatusCondition.")
      .def_property(
          "enabled_statuses",
          (const dds::core::status::StatusMask (PyStatusCondition::*)() const) &
              PyStatusCondition::enabled_statuses,
          (void (PyStatusCondition::*)(const dds::core::status::StatusMask &)) &
              PyStatusCondition::enabled_statuses,
      ...
      .def(
          ...
          py::arg("func"), "Set a handler function for this StatusCondition.")
      .def(
          "reset_handler", [](PyStatusCondition &sc) { sc->reset_handler(); },
          "Resets the handler for this StatusCondition.")
      .def("dispatch", &PyStatusCondition::dispatch,
           "Dispatches the functions registered with the condition.")
      .def_property_readonly("trigger_value", &PyStatusCondition::trigger_value,
...
template <>
void process_inits<dds::core::cond::StatusCondition>(py::module &m,
                                                     ClassInitList &l) {
