...
template <> void init_class_defs(py::class_<LivelinessLostStatus> &cls) {
  cls.def_property_readonly(
         "total_count", &LivelinessLostStatus::total_count,
      ...
      .def_property_readonly(
          "total_count_change", &LivelinessLostStatus::total_count_change,
