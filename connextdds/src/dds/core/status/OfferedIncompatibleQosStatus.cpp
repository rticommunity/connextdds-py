...
void init_class_defs(py::class_<OfferedIncompatibleQosStatus> &cls) {
  cls.def_property_readonly(
         "total_count", &OfferedIncompatibleQosStatus::total_count,
         "Total number of times the concerned DataWriter discovered a "
         "DataReader for the same Topic, common partition with a requested QoS "
         "that is incompatible with that offered by the DataWriter.")
      ...
      .def_property_readonly(
          "last_policy_id", &OfferedIncompatibleQosStatus::last_policy_id,
          "The policy ID of one of the policies that was found to be "
          "incompatible the last time an incompatibility was detected.")
      .def_property_readonly(
          "policies", &OfferedIncompatibleQosStatus::policies,
...
template <>
void process_inits<OfferedIncompatibleQosStatus>(py::module &m,
                                                 ClassInitList &l) {
  l.push_back([m]() mutable {
    return init_class<OfferedIncompatibleQosStatus>(
        m, "OfferedIncompatibleQosStatus");
  });
}
