...
template <> void init_class_defs(py::class_<InconsistentTopicStatus> &cls) {
  cls.def_property_readonly(
         "total_count", &InconsistentTopicStatus::total_count,
      ...
      .def_property_readonly(
          "total_count_change", &InconsistentTopicStatus::total_count_change,
