...
template <> void init_class_defs(py::class_<LivelinessChangedStatus> &cls) {
  cls.def_property_readonly(
         "alive_count", &LivelinessChangedStatus::alive_count,
         "The number of currently alive DataWriters that write to the "
         "Topic of the DataReader.")
      .def_property_readonly(
          "not_alive_count", &LivelinessChangedStatus::not_alive_count,
          "The number of currently NOT_ALIVE DataWriters that write to "
          "the Topic of the DataReader.")
      .def_property_readonly(
          "alive_count_change", &LivelinessChangedStatus::alive_count_change,
...
void process_inits<LivelinessChangedStatus>(py::module &m, ClassInitList &l) {
  l.push_back([m]() mutable {
    return init_class<LivelinessChangedStatus>(m, "LivelinessChangedStatus");
  });
}
