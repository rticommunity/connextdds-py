...
template <> void init_class_defs(py::class_<DurabilityService> &cls) {
  cls.def(py::init<>(), "Creates the default policy.")
      .def(py::init<const dds::core::Duration &, HistoryKind, int32_t, int32_t,
                    int32_t, int32_t>(),
           py::arg("service_cleanup_delay"), py::arg("history_kind"),
           py::arg("history_depth"), py::arg("max_samples"),
