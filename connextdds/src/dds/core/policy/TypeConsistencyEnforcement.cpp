...
void init_class_defs(py::class_<TypeConsistencyEnforcement>& cls) {
    cls
        ...
        .def_property(
            "kind",
            (TypeConsistencyEnforcementKind (TypeConsistencyEnforcement::*)() const) &TypeConsistencyEnforcement::kind,
        ...
        .def_property(
            ...
            (TypeConsistencyEnforcement& (TypeConsistencyEnforcement::*)(bool)) &TypeConsistencyEnforcement::ignore_sequence_bounds,
            "Controls whether sequence bounds are ignored."
        )
        .def_property(
            "ignore_string_bounds",
            (bool (TypeConsistencyEnforcement::*)() const) &TypeConsistencyEnforcement::ignore_string_bounds,
            (TypeConsistencyEnforcement& (TypeConsistencyEnforcement::*)(bool)) &TypeConsistencyEnforcement::ignore_string_bounds,
            "Controls whether string bounds are ignored."
        )
        .def_property(
            "ignore_member_names",
            (bool (TypeConsistencyEnforcement::*)() const) &TypeConsistencyEnforcement::ignore_member_names,
            (TypeConsistencyEnforcement& (TypeConsistencyEnforcement::*)(bool)) &TypeConsistencyEnforcement::ignore_member_names,
            "Controls whether member names are ignored."
        )
        .def_property(
            "prevent_type_widening",
            (bool (TypeConsistencyEnforcement::*)() const) &TypeConsistencyEnforcement::prevent_type_widening,
            (TypeConsistencyEnforcement& (TypeConsistencyEnforcement::*)(bool)) &TypeConsistencyEnforcement::prevent_type_widening,
            "Controls whether type widening is prevented."
        )
        .def_property(
            "force_type_validation",
            (bool (TypeConsistencyEnforcement::*)() const) &TypeConsistencyEnforcement::force_type_validation,
            (TypeConsistencyEnforcement& (TypeConsistencyEnforcement::*)(bool)) &TypeConsistencyEnforcement::force_type_validation,
            "Controls whether type validation is forced."
        )
        .def_property(
            "ignore_enum_literal_names",
            (bool (TypeConsistencyEnforcement::*)() const) &TypeConsistencyEnforcement::ignore_enum_literal_names,
            (TypeConsistencyEnforcement& (TypeConsistencyEnforcement::*)(bool)) &TypeConsistencyEnforcement::ignore_enum_literal_names,
