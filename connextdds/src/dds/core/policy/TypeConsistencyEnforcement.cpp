...
template <> void init_class_defs(py::class_<TypeConsistencyEnforcement> &cls) {
  cls.def(py::init<>(), "Creates the default policy.")
      .def(py::init<TypeConsistencyEnforcementKind>(), py::arg("kind"),
           "Creates an instance with a specific enforcement kind.")
      .def_property(
          "kind",
          (TypeConsistencyEnforcementKind(TypeConsistencyEnforcement::*)()
               const) &
      ...
      .def_property(
          ...
          (TypeConsistencyEnforcement & (TypeConsistencyEnforcement::*)(bool)) &
              TypeConsistencyEnforcement::ignore_sequence_bounds,
...
static void init_type_consistency_enforcement_kind(py::module &m) {
  init_dds_safe_enum<TypeConsistencyEnforcementKind_def>(
      m, "TypeConsistencyEnforcementKind", [](py::object &o) {
        py::enum_<TypeConsistencyEnforcementKind::type>(o, "Enum")
            ...
            .value(
                ...
                "The DataWriter and the DataReader need not support the same "
                "data "
...
template <>
void process_inits<TypeConsistencyEnforcement>(py::module &m,
                                               ClassInitList &l) {
  l.push_back([m]() mutable {
    init_type_consistency_enforcement_kind(m);
    return init_class<TypeConsistencyEnforcement>(m,
                                                  "TypeConsistencyEnforcement");
  });
}
