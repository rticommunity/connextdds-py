...
template <> void init_class_defs(py::class_<Reliability> &cls) {
  cls.def(py::init<>(), "Creates a best-effort policy.")
      ...
      .def_property(
          "kind", (ReliabilityKind(Reliability::*)() const) & Reliability::kind,
      ...
      .def_property(
          ...
          (Reliability & (Reliability::*)(const dds::core::Duration &)) &
              Reliability::max_blocking_time,
      ...
      .def_property(
          "acknowledgment_kind",
          [](const Reliability &r) { return r->acknowledgment_kind(); },
      ...
      .def_static(
          ...
          "max blocking time.")
      .def_static("best_effort", &Reliability::BestEffort,
...
static void init_dds_reliability_kind(py::module &m) {
  init_dds_safe_enum<
    ...
    py::enum_<ReliabilityKind::type>(o, "Enum")
        .value(
            "BEST_EFFORT", ReliabilityKind::type::BEST_EFFORT,
        ...
        .value("RELIABLE", ReliabilityKind::type::RELIABLE,
...
template <> void process_inits<Reliability>(py::module &m, ClassInitList &l) {
