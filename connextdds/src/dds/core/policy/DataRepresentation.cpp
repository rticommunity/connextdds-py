...
template <> void init_class_defs(py::class_<DataRepresentation> &cls) {
  cls.def(py::init<>(), "Creates an instance with one element, AUTO_ID.")
      .def(py::init<const std::vector<int16_t> &>(), py::arg("representations"),
      ...
      .def_property_readonly_static(
          "XCDR", [](py::object &) { return DataRepresentation::xcdr(); },
          "Extended Common Data Representation ID for encoding version 1.")
      .def_property_readonly_static(
          "XML", [](py::object &) { return DataRepresentation::xml(); },
          "XML Data Representation ID (unsupported).")
      .def_property_readonly_static(
          "XCDR2", [](py::object &) { return DataRepresentation::xcdr2(); },
          "Extended Common Data Representation ID for encoding version 2.")
      .def_property_readonly_static(
          "AUTO_ID", [](py::object &) { return DataRepresentation::auto_id(); },
