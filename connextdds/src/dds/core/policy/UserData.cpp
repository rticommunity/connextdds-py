...
template <> void init_class_defs(py::class_<UserData> &cls) {
  cls.def(py::init<>(), "Creates an instance with an empty sequence of bytes.")
      ...
      .def(
          "__iter__",
          [](UserData &ud) { return py::make_iterator(ud.begin(), ud.end()); },
          py::keep_alive<0, 1>())
      .def(py::self == py::self, "Test for equality.")
      .def(py::self != py::self, "Test for inequality.");
}

template <> void process_inits<UserData>(py::module &m, ClassInitList &l) {
