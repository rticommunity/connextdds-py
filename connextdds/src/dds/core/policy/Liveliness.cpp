...
void pyrti::init_class_defs(py::class_<Liveliness>& cls) {
    cls
        ...
        .def_property(
            "lease_duration",
            (dds::core::Duration (Liveliness::*)() const) &Liveliness::lease_duration,
            (Liveliness& (Liveliness::*)(const dds::core::Duration&)) &Liveliness::lease_duration,
        ...
        .def_static(
            ...
            py::arg("lease") = dds::core::Duration::infinite(),
...
static
void init_dds_liveliness_kind(py::module& m) {
    auto lk = init_dds_safe_enum<LivelinessKind_def>(m, "LivelinessKind");

    py::enum_<LivelinessKind::type>(lk, "LivelinessKind")
        .value(
            "AUTOMATIC",
