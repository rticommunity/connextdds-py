...
template <> void init_class_defs(py::class_<ReaderDataLifecycle> &cls) {
  cls.def(py::init<>(), "Creates the default policy.")
      .def(py::init<const dds::core::Duration &, const dds::core::Duration &>(),
           py::arg("nowriter_delay"), py::arg("disposed_samples_delay"),
           "Creates an instance with the specified nowriter and "
           "disposed-samples purge delays.")
      .def_property("autopurge_unregistered_instances_delay",
      ...
      .def_property("autopurge_disposed_samples_delay",
                    (dds::core::Duration(ReaderDataLifecycle::*)() const) &
      ...
      .def_property(
          ...
          "\n\n"
          "This property's getter returns a deep copy.")
      .def_static("no_auto_purge", &ReaderDataLifecycle::NoAutoPurge,
