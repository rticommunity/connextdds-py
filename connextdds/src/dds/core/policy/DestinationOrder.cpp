...
template<>
void pyrti::init_class_defs(py::class_<DestinationOrder>& cls) {
    cls
        .def(
            py::init<>(),
        ...
        .def_property(
            "kind",
            (DestinationOrderKind (DestinationOrder::*)() const) &DestinationOrder::kind,
            (DestinationOrder& (DestinationOrder::*)(DestinationOrderKind)) &DestinationOrder::kind,
        ...
        .def_property(
            ...
            [](DestinationOrder& d, rti::core::policy::DestinationOrderScopeKind k) {
                return d->scope(k);
            },
...
template<>
void pyrti::process_inits<DestinationOrder>(py::module& m, pyrti::ClassInitList& l) {
    l.push_back(
        [m]() mutable {
            init_dds_destination_order_kind(m);
            return pyrti::init_class<DestinationOrder>(m, "DestinationOrder");
        }
    );
}