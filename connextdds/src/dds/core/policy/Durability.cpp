...
template <> void init_class_defs(py::class_<Durability> &cls) {
  cls.def(py::init<>(), "Create an empty Durability QoS policy.")
      .def(py::init<DurabilityKind>(), py::arg("kind"),
           "Create a Durability QoS policy with the given kind.")
      .def_property(
          "kind", (DurabilityKind(Durability::*)() const) & Durability::kind,
          (Durability & (Durability::*)(DurabilityKind)) & Durability::kind,
          "Get/set the Durability kind.")
      .def_property(
          "direct_communication",
          [](Durability &d) { return d->direct_communication(); },
          [](Durability &d, bool v) { return d->direct_communication(v); },
          "Get/set whether a DataReader should receive samples directly "
          "from a TRANSIENT or PERSISTENT DataWriter.")
      .def_static("volatile", &Durability::Volatile,
      ...
      .def_static("transient", &Durability::Transient,
                  "Create a Durability QoS policy with kind set to TRANSIENT.")
      .def_static("persistent", &Durability::Persistent,
...
static void init_dds_durability_kind(py::module &m) {
  init_dds_safe_enum<
    ...
    py::enum_<DurabilityKind::type>(o, "Enum")
        .value(
            "VOLATILE", DurabilityKind::type::VOLATILE,
        ...
        .value(
            "TRANSIENT_LOCAL", DurabilityKind::type::TRANSIENT_LOCAL,
            ...
            "This option does not require RTI Persistence Service.")
        .value(
            "TRANSIENT", DurabilityKind::type::TRANSIENT,
            "RTI Connext will attempt to keep some samples so that they can "
            "be delivered to any potential late-joining DataReader."
            "\n\n"
            "Which particular samples are kept depends on other QoS such as "
        ...
        .value("PERSISTENT", DurabilityKind::type::PERSISTENT,
...
template <> void process_inits<Durability>(py::module &m, ClassInitList &l) {
