...
py::object py_cast_type(dds::core::xtypes::DynamicType& dt) {
    switch (dt.kind().underlying()) {
        ...
        case dds::core::xtypes::TypeKind::UINT_8_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<uint8_t>&>(dt));
        case dds::core::xtypes::TypeKind::INT_16_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<int16_t>&>(dt));
        case dds::core::xtypes::TypeKind::UINT_16_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<uint16_t>&>(dt));
        case dds::core::xtypes::TypeKind::INT_32_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<int32_t>&>(dt));
        case dds::core::xtypes::TypeKind::UINT_32_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<uint32_t>&>(dt));
        case dds::core::xtypes::TypeKind::INT_64_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<rti::core::int64>&>(dt));
        case dds::core::xtypes::TypeKind::UINT_64_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<rti::core::uint64>&>(dt));
        ...
        case dds::core::xtypes::TypeKind::FLOAT_64_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<double>&>(dt));
        case dds::core::xtypes::TypeKind::FLOAT_128_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<rti::core::LongDouble>&>(dt));
        ...
        case dds::core::xtypes::TypeKind::CHAR_16_TYPE:
            return py::cast(static_cast<dds::core::xtypes::PrimitiveType<DDS_Wchar>&>(dt));
#endif  
        default:
            return py::cast(dt);
    }
