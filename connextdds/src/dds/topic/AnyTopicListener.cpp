...
template <>
void init_class_defs(py::class_<PyNoOpAnyTopicListener, PyAnyTopicListener,
...
template <>
void process_inits<dds::topic::AnyTopicListener>(py::module &m,
                                                 ClassInitList &l) {
  ...
  l.push_back([m]() mutable {
    return init_class<PyNoOpAnyTopicListener, PyAnyTopicListener,
