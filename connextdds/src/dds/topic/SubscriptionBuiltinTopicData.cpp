...
void init_dds_typed_topic_template(
    py::class_<PyTopic<dds::topic::SubscriptionBuiltinTopicData>,
...
void init_class_defs(py::class_<SubscriptionBuiltinTopicData> &cls) {
  cls.def(py::init<>(), "Create a default SubscriptionBuiltinTopicData.")
      .def_property_readonly("key", &SubscriptionBuiltinTopicData::key,
                             "The DCPS key to distinguish entries.")
      .def_property_readonly(
          "participant_key", &SubscriptionBuiltinTopicData::participant_key,
      ...
      .def_property_readonly(
          "property",
          [](const SubscriptionBuiltinTopicData &p) { return p->property(); },
      ...
      .def_property_readonly(
          "service",
          [](const SubscriptionBuiltinTopicData &p) { return p->service(); },
          "The Service policy")
      .def_property_readonly_static(
          "topic_name",
          [](py::object &) { return dds::topic::subscription_topic_name(); },
...
template <>
void process_inits<SubscriptionBuiltinTopicData>(py::module &m,
                                                 ClassInitList &l) {
  l.push_back([m, &l]() mutable {
    return init_type_class<SubscriptionBuiltinTopicData>(
        m, l, "SubscriptionBuiltinTopicData");
  });
}
