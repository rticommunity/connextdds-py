...
void init_dds_typed_topic_template(
    py::class_<PyTopic<dds::topic::ParticipantBuiltinTopicData>,
               PyITopicDescription<dds::topic::ParticipantBuiltinTopicData>,
               PyIAnyTopic> &cls) {
  init_dds_typed_topic_base_template(cls);
}

template <> void init_class_defs(py::class_<ParticipantBuiltinTopicData> &cls) {
  cls.def(py::init<>(), "Create a default ParticipantBuiltinTopicData.")
      .def_property_readonly("key", &ParticipantBuiltinTopicData::key,
                             "Get the DCPS key to distinguish entries.")
      .def_property_readonly(
          "user_data", &ParticipantBuiltinTopicData::user_data,
          "Get the UserData policy of the corresponding DomainParticipant.")
      .def_property_readonly(
          "property",
          [](const ParticipantBuiltinTopicData &p) { return p->property(); },
          "Get the UserData policy of the corresponding DomainParticipant.")
      .def_property_readonly(
      ...
      .def_property_readonly(
          "domain_id",
          [](const ParticipantBuiltinTopicData &p) { return p->domain_id(); },
      ...
      .def_property_readonly_static(
          "topic_name",
          [](py::object &) { return dds::topic::participant_topic_name(); },
...
template <>
void process_inits<ParticipantBuiltinTopicData>(py::module &m,
                                                ClassInitList &l) {
  l.push_back([m, &l]() mutable {
    return init_type_class<ParticipantBuiltinTopicData>(
        m, l, "ParticipantBuiltinTopicData");
  });
}
