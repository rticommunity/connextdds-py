...
template <> void init_class_defs(py::class_<SampleInfo> &cls) {
  cls.def_property_readonly("source_timestamp", &SampleInfo::source_timestamp,
                            "The DataWriter's write timestamp.")
      .def_property_readonly("state", &SampleInfo::state,
                             "Get the DataState of the sample.")
      .def_property_readonly("generation_count", &SampleInfo::generation_count,
                             "The GenerationCount of the sample.")
      .def_property_readonly("rank", &SampleInfo::rank,
                             "Get the Rank of the sample.")
      .def_property_readonly(
          "valid", &SampleInfo::valid,
          ...
          "instance.")
      .def_property_readonly("instance_handle", &SampleInfo::instance_handle,
                             "Identifies locally the corresponding instance.")
      .def_property_readonly(
          "publication_handle", &SampleInfo::publication_handle,
          "Identifies locally the DataWriter that modified the instance.")
      .def_property_readonly(
          "reception_timestamp",
          [](const SampleInfo &s) { return s->reception_timestamp(); },
          "The timestamp when the sample was committed by a DataReader.")
      .def_property_readonly(
          "publication_sequence_number",
          [](const SampleInfo &s) { return s->publication_sequence_number(); },
          "Publication sequence number assigned when the DDS sample was "
          "written by the DataWriter.")
      .def_property_readonly(
          "reception_sequence_number",
          [](const SampleInfo &s) { return s->reception_sequence_number(); },
          "Reception sequence number assigned when the DDS sample was "
      ...
      .def_property_readonly(
          ...
          "\n\n"
          "If the Publisher’s access_scope is GROUP, this field contains "
          "the Publisher virtual GUID that uniquely identifies the DataWriter "
          "group.")
      .def_property_readonly(
          ...
          "\n\n"
          "If the Publisher’s access_scope is GROUP, this field contains "
          "the Publisher virtual sequence number that uniquely identifies a "
      ...
      .def_property_readonly(
          ...
          "The original publication virtual sequence number of a related "
          "sample.")
      .def_property_readonly(
          ...
          "related_original_publication_virtual_sequence_number combined "
          "in a SampleIdentity instance.")
      .def_property_readonly(
          "flag", [](const SampleInfo &s) { return s->flag(); },
          "Flags associated with the sample.")
      .def_property_readonly(
          "source_guid", [](const SampleInfo &s) { return s->source_guid(); },
          "The application logical data source associated with the sample.")
      .def_property_readonly(
          "related_source_guid",
          [](const SampleInfo &s) { return s->related_source_guid(); },
          "The application logical data source that is related to the "
          "sample.")
      .def_property_readonly(
          "related_subscription_guid",
          [](const SampleInfo &s) { return s->related_subscription_guid(); },
...
template <> void process_inits<SampleInfo>(py::module &m, ClassInitList &l) {
  l.push_back(
