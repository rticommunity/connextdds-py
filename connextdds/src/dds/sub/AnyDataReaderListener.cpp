...
template <>
void init_class_defs(py::class_<PyAnyDataReaderListener,
  ...
  cls.def(py::init<>())
      ...
      .def(
          "on_sample_lost",
          (void (PyAnyDataReaderListener::*)(
              PyAnyDataReader &, const dds::core::status::SampleLostStatus &)) &
...
void init_class_defs(
    py::class_<PyNoOpAnyDataReaderListener, PyAnyDataReaderListener,
  ...
  cls.def(py::init<>())
      .def("on_requested_deadline_missed",
           (void (PyNoOpAnyDataReaderListener::*)(
               PyAnyDataReader &,
               const dds::core::status::RequestedDeadlineMissedStatus &)) &
               PyNoOpAnyDataReaderListener::on_requested_deadline_missed,
           "Requested deadline missed callback.")
      .def("on_requested_incompatible_qos",
           (void (PyNoOpAnyDataReaderListener::*)(
               PyAnyDataReader &,
               const dds::core::status::RequestedIncompatibleQosStatus &)) &
               PyNoOpAnyDataReaderListener::on_requested_incompatible_qos,
           "Requested incompatible QoS callback.")
      .def("on_sample_rejected",
           (void (PyNoOpAnyDataReaderListener::*)(
               PyAnyDataReader &,
...
template <>
void process_inits<dds::sub::AnyDataReaderListener>(py::module &m,
                                                    ClassInitList &l) {
  l.push_back([m]() mutable {
    return init_class<PyAnyDataReaderListener,
                      PyAnyDataReaderListenerTrampoline<>>(
        m, "AnyDataReaderListener");
  });

  l.push_back([m]() mutable {
    return init_class<PyNoOpAnyDataReaderListener, PyAnyDataReaderListener,
                      PyNoOpAnyDataReaderListenerTrampoline<>>(
        m, "NoOpAnyDataReaderListener");
  });
}
