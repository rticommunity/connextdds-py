...
void init_class_defs(py::class_<DataReaderQos>& cls) {
    ...
    add_qos_property<DataReaderQos, Reliability>(cls, "reliability", "Reliability");
    add_qos_property<DataReaderQos, DestinationOrder>(cls, "destination_order", "DestinationOrder");
    add_qos_property<DataReaderQos, History>(cls, "history", "History");
    add_qos_property<DataReaderQos, ResourceLimits>(cls, "resource_limits", "ResourceLimits");
    ...
    add_qos_property<DataReaderQos, TransportUnicast>(cls, "transport_unicast", "TransportUnicast");
    add_qos_property<DataReaderQos, TransportMulticast>(cls, "transport_multicast", "TransportMulticast");
