...
template <>
void init_class_defs(py::class_<PyAnyDataWriterListener,
  ...
  cls.def(py::init<>())
      ...
      .def("on_reliable_writer_cache_changed",
           (void (PyAnyDataWriterListener::*)(
               ...
               PyAnyDataWriterListener::on_reliable_writer_cache_changed,
      ...
      .def(
          ...
          (void (PyAnyDataWriterListener::*)(
              ...
              PyAnyDataWriterListener::on_reliable_reader_activity_changed,
          "Reliable reader activity changed callback.")
      .def("on_instance_replaced",
           (void (PyAnyDataWriterListener::*)(
               PyAnyDataWriter &, const dds::core::InstanceHandle &)) &
               PyAnyDataWriterListener::on_instance_replaced,
           "On instance replaced callback.")
      .def("on_application_acknowledgment",
           (void (PyAnyDataWriterListener::*)(
               PyAnyDataWriter &, const rti::pub::AcknowledgmentInfo &)) &
               PyAnyDataWriterListener::on_application_acknowledgment,
...
void init_class_defs(
    py::class_<PyNoOpAnyDataWriterListener, PyAnyDataWriterListener,
  ...
  cls.def(py::init<>())
      .def("on_offered_deadline_missed",
           (void (PyNoOpAnyDataWriterListener::*)(
               PyAnyDataWriter &,
               const dds::core::status::OfferedDeadlineMissedStatus &)) &
               PyNoOpAnyDataWriterListener::on_offered_deadline_missed,
           "Offered deadline missed callback.")
      .def("on_offered_incompatible_qos",
           (void (PyNoOpAnyDataWriterListener::*)(
               PyAnyDataWriter &,
               const dds::core::status::OfferedIncompatibleQosStatus &)) &
               PyNoOpAnyDataWriterListener::on_offered_incompatible_qos,
           "Offered incompatible QoS callback.")
      .def("on_liveliness_lost",
           (void (PyNoOpAnyDataWriterListener::*)(
               PyAnyDataWriter &,
      ...
      .def("on_reliable_writer_cache_changed",
           (void (PyNoOpAnyDataWriterListener::*)(
               PyAnyDataWriter &,
               const rti::core::status::ReliableWriterCacheChangedStatus &)) &
               PyNoOpAnyDataWriterListener::on_reliable_writer_cache_changed,
           "Reliable writer cache changed callback.")
      .def(
          "on_reliable_reader_activity_changed",
          (void (PyNoOpAnyDataWriterListener::*)(
              PyAnyDataWriter &,
              const rti::core::status::ReliableReaderActivityChangedStatus &)) &
              PyNoOpAnyDataWriterListener::on_reliable_reader_activity_changed,
          "Reliable reader activity changed callback.")
      .def("on_instance_replaced",
           (void (PyNoOpAnyDataWriterListener::*)(
               PyAnyDataWriter &, const dds::core::InstanceHandle &)) &
      ...
      .def("on_application_acknowledgment",
           (void (PyNoOpAnyDataWriterListener::*)(
               PyAnyDataWriter &, const rti::pub::AcknowledgmentInfo &)) &
               PyNoOpAnyDataWriterListener::on_application_acknowledgment,
           "On application acknowledgment callback")
      .def("on_service_request_accepted",
           (void (PyNoOpAnyDataWriterListener::*)(
               PyAnyDataWriter &,
               const rti::core::status::ServiceRequestAcceptedStatus &)) &
               PyNoOpAnyDataWriterListener::on_service_request_accepted,
           "On service request accepted callback.");
}

template <>
void process_inits<dds::pub::AnyDataWriterListener>(py::module &m,
                                                    ClassInitList &l) {
  l.push_back([m]() mutable {
    return init_class<PyAnyDataWriterListener,
                      PyAnyDataWriterListenerTrampoline<>>(
        m, "AnyDataWriterListener");
  });

  l.push_back([m]() mutable {
    return init_class<PyNoOpAnyDataWriterListener, PyAnyDataWriterListener,
                      PyNoOpAnyDataWriterListenerTrampoline<>>(
        m, "NoOpAnyDataWriterListener");
  });
}
