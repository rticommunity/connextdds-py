...
void init_class_defs(py::class_<DomainParticipantQos>& cls) {
    ...
    add_qos_property<DomainParticipantQos, DomainParticipantResourceLimits>(cls, "domain_participant_resource_limits", "DomainParticipantResourceLimits");
    ...
    add_qos_property<DomainParticipantQos, EntityName>(cls, "entity_name", "EntityName");
