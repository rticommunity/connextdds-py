...
public:
  ...
  void on_instance_replaced(PyAnyDataWriter &writer,
  ...
  void
  on_sample_lost(PyAnyDataReader &reader,
...
public:
  ...
  void on_instance_replaced(dds::pub::AnyDataWriter &writer,
                            const dds::core::InstanceHandle &handle) override {
    auto adw = PyAnyDataWriter(writer);
  ...
  void on_offered_deadline_missed(
      PyAnyDataWriter &writer,
      const dds::core::status::OfferedDeadlineMissedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_offered_deadline_missed, writer,
                           status);
  }
  ...
  void on_offered_incompatible_qos(
      PyAnyDataWriter &writer,
      const dds::core::status::OfferedIncompatibleQosStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_offered_incompatible_qos, writer,
                           status);
  }
  ...
  void on_liveliness_lost(
      PyAnyDataWriter &writer,
      const dds::core::status::LivelinessLostStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_liveliness_lost, writer, status);
  }

  void on_publication_matched(
      PyAnyDataWriter &writer,
      const dds::core::status::PublicationMatchedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_publication_matched, writer,
                           status);
  }
  ...
  void on_reliable_writer_cache_changed(
      ...
      const rti::core::status::ReliableWriterCacheChangedStatus &status)
      override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_reliable_writer_cache_changed,
                           writer, status);
  }
  ...
  void on_reliable_reader_activity_changed(
      ...
      const rti::core::status::ReliableReaderActivityChangedStatus &status)
      override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_reliable_reader_activity_changed,
                           writer, status);
  }

  void on_instance_replaced(PyAnyDataWriter &writer,
                            const dds::core::InstanceHandle &handle) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_instance_replaced, writer, handle);
  }

  void on_application_acknowledgment(
      PyAnyDataWriter &writer,
      const rti::pub::AcknowledgmentInfo &acknowledgment_info) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_application_acknowledgment, writer,
                           acknowledgment_info);
  }
  ...
  void on_service_request_accepted(
      PyAnyDataWriter &writer,
      const rti::core::status::ServiceRequestAcceptedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_service_request_accepted, writer,
                           status);
  }
  ...
  void
  on_sample_lost(dds::sub::AnyDataReader &reader,
                 const dds::core::status::SampleLostStatus &status) override {
    auto adr = PyAnyDataReader(reader);
  ...
  void on_requested_deadline_missed(
      PyAnyDataReader &reader,
      const dds::core::status::RequestedDeadlineMissedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_requested_deadline_missed, reader,
                           status);
  }
  ...
  void on_requested_incompatible_qos(
      ...
      const dds::core::status::RequestedIncompatibleQosStatus &status)
      override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_requested_incompatible_qos, reader,
                           status);
  }
  ...
  void on_sample_rejected(
      PyAnyDataReader &reader,
      const dds::core::status::SampleRejectedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_sample_rejected, reader, status);
  }

  void on_liveliness_changed(
      PyAnyDataReader &reader,
      const dds::core::status::LivelinessChangedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_liveliness_changed, reader,
                           status);
  }
  ...
  void on_subscription_matched(
      PyAnyDataReader &reader,
      const dds::core::status::SubscriptionMatchedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_subscription_matched, reader,
                           status);
  }
  ...
  void on_inconsistent_topic(
      PyAnyTopic &topic,
      const dds::core::status::InconsistentTopicStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, DPLBase, on_inconsistent_topic, topic, status);
  }
...
public:
  ...
  void on_offered_deadline_missed(
      PyAnyDataWriter &writer,
      const dds::core::status::OfferedDeadlineMissedStatus &status) override {
    PYBIND11_OVERLOAD(void, DPLBase, on_offered_deadline_missed, writer,
                      status);
  }
  ...
  void on_offered_incompatible_qos(
      PyAnyDataWriter &writer,
      const dds::core::status::OfferedIncompatibleQosStatus &status) override {
    PYBIND11_OVERLOAD(void, DPLBase, on_offered_incompatible_qos, writer,
                      status);
  }
  ...
  void on_publication_matched(
      PyAnyDataWriter &writer,
      const dds::core::status::PublicationMatchedStatus &status) override {
    PYBIND11_OVERLOAD(void, DPLBase, on_publication_matched, writer, status);
  }
  ...
  void on_reliable_writer_cache_changed(
      ...
      const rti::core::status::ReliableWriterCacheChangedStatus &status)
      override {
    PYBIND11_OVERLOAD(void, DPLBase, on_reliable_writer_cache_changed, writer,
                      status);
  }
  ...
  void on_reliable_reader_activity_changed(
      ...
      const rti::core::status::ReliableReaderActivityChangedStatus &status)
      override {
    PYBIND11_OVERLOAD(void, DPLBase, on_reliable_reader_activity_changed,
                      writer, status);
  }
  ...
  void on_application_acknowledgment(
      PyAnyDataWriter &writer,
      const rti::pub::AcknowledgmentInfo &acknowledgment_info) override {
    PYBIND11_OVERLOAD(void, DPLBase, on_application_acknowledgment, writer,
                      acknowledgment_info);
  }
  ...
  void on_service_request_accepted(
      PyAnyDataWriter &writer,
      const rti::core::status::ServiceRequestAcceptedStatus &status) override {
    PYBIND11_OVERLOAD(void, DPLBase, on_service_request_accepted, writer,
                      status);
  }
  ...
  void on_requested_deadline_missed(
      PyAnyDataReader &reader,
      const dds::core::status::RequestedDeadlineMissedStatus &status) override {
    PYBIND11_OVERLOAD(void, DPLBase, on_requested_deadline_missed, reader,
                      status);
  }
  ...
  void on_requested_incompatible_qos(
      ...
      const dds::core::status::RequestedIncompatibleQosStatus &status)
      override {
    PYBIND11_OVERLOAD(void, DPLBase, on_requested_incompatible_qos, reader,
                      status);
  }
  ...
  void on_subscription_matched(
      PyAnyDataReader &reader,
      const dds::core::status::SubscriptionMatchedStatus &status) override {
    PYBIND11_OVERLOAD(void, DPLBase, on_subscription_matched, reader, status);
  }
