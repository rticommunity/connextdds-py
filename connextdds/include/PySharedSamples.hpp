...
void init_shared_samples_defs(py::class_<dds::sub::SharedSamples<T>> &cls) {
  cls.def(py::init<dds::sub::LoanedSamples<T> &>(), py::arg("loaned_samples"),
          "Constructs an instance of SharedSamples, removing ownership of the "
          "loan from the Loaned Samples.")
      .def("__len__", &dds::sub::SharedSamples<T>::length,
      ...
      .def(
          ...
          py::keep_alive<0, 1>(), "Make a sample iterator")
