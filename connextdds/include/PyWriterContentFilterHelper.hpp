...
namespace pyrti {
    ...
    template<typename T>
    void init_writer_content_filter_helper_defs(py::class_<rti::topic::WriterContentFilterHelper<T, py::object, py::object>, pyrti::PyWriterContentFilterHelper<T>>& cls) {
        cls
            .def(
            ...
            .def(
                "add_cookie",
                static_cast<void (rti::topic::WriterContentFilter<T, py::object, py::object>::*)(rti::core::Cookie&)>(&pyrti::PyWriterContentFilterHelperHelper<T>::add_cookie),
                py::arg("cookie"),
    ...
    void init_writer_content_filter_helper(py::object o) {
        py::class_<rti::topic::WriterContentFilterHelper<T, py::object, py::object>, pyrti::PyWriterContentFilterHelper<T>> wcfh(o, "WriterContentFilterHelper");

        pyrti::init_writer_content_filter_helper_defs(wcfh);
    }
}