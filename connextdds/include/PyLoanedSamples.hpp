...
void init_loaned_samples_defs(py::class_<dds::sub::LoanedSamples<T>> &cls) {
  cls.def(py::init<>(), "Create an empty LoanedSamples object.")
      ...
      .def("__len__", &dds::sub::LoanedSamples<T>::length,
           "Get the number of samples in the loan.")
      .def_property_readonly("length", &dds::sub::LoanedSamples<T>::length,
                             "Get the number of samples in the loan.")
      .def("return_loan", &dds::sub::LoanedSamples<T>::return_loan,
      ...
      .def(
          ...
          "Enter a context for the loaned samples, loan returned on context "
          "exit.")
      .def(
          "__exit__",
          [](dds::sub::LoanedSamples<T> &ls, py::object, py::object,
