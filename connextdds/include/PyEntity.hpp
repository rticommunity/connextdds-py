...
public:
  ...
  PyPublisher(const PyDomainParticipant &p,
              const dds::pub::qos::PublisherQos &q, PyPublisherListener *l,
              const dds::core::status::StatusMask &m);
...
public:
  ...
  PySubscriber(const PyDomainParticipant &p,
               const dds::sub::qos::SubscriberQos &q, PySubscriberListener *l,
               const dds::core::status::StatusMask &m);
