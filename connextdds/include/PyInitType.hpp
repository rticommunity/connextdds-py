...
DefInitFunc init_type_class(py::object& parent, ClassInitList& l, const std::string& cls_name) {
    ...
    l.push_back(
        [cls] {
            py::class_<PyDataReaderListener<T>, PyDataReaderListenerTrampoline<T>> drl(cls, "DataReaderListener");
            py::class_<PyNoOpDataReaderListener<T>, PyDataReaderListener<T>, PyNoOpDataReaderListenerTrampoline<T>> nodrl(cls, "NoOpDataReaderListener");
    ...
    l.push_back(
        [cls] {
            py::class_<PyDataWriterListener<T>, PyDataWriterListenerTrampoline<T>> dwl(cls, "DataWriterListener");
            py::class_<PyNoOpDataWriterListener<T>, PyDataWriterListener<T>, PyNoOpDataWriterListenerTrampoline<T>> nodwl(cls, "NoOpDataWriterListener");
    ...
    l.push_back(
        [cls] {
            py::class_<PyTopicListener<T>, PyTopicListenerTrampoline<T>> tl(cls, "TopicListener");
            py::class_<PyNoOpTopicListener<T>, PyTopicListener<T>, PyNoOpTopicListenerTrampoline<T>> notl(cls, "NoOpTopicListener");

            return (
                [tl, notl]() mutable {
                    init_topic_listener<T>(tl, notl);
                }
            );
        }
    );
    ...
    l.push_back(
        [cls] {
            ...
            return (
                [vls]() mutable {
                    init_valid_loaned_samples<T>(vls);
                }
            );
        }
    );
    ...
    l.push_back(
        [cls] {
            ...
            return (
                [cft]() mutable {
                    init_content_filtered_topic<T>(cft);
                }
            );
        }
    );
    ...
    l.push_back(
        [cls] {
            py::class_<rti::topic::ContentFilter<T, dds::core::optional<py::object>>, rti::topic::ContentFilterBase, PyContentFilter<T>> cf(cls, "ContentFilter");

            return (
                [cf]() mutable {
                    init_content_filter<T>(cf);
                }
            );
        }
    );
    ...
    l.push_back(
        [cls] {
            py::class_<rti::topic::WriterContentFilter<T, dds::core::optional<py::object>, dds::core::optional<py::object>>, rti::topic::ContentFilter<T, dds::core::optional<py::object>>, PyWriterContentFilter<T>> wcf(cls, "WriterContentFilter");

            return (
                [wcf]() mutable {
                    init_writer_content_filter<T>(wcf);
                }
            );
        }
    );
    ...
    l.push_back(
        [cls] {
            py::class_<rti::topic::WriterContentFilterHelper<T, dds::core::optional<py::object>, dds::core::optional<py::object>>, rti::topic::WriterContentFilter<T, dds::core::optional<py::object>, dds::core::optional<py::object>>, PyWriterContentFilterHelper<T>> wcfh(cls, "WriterContentFilterHelper");
