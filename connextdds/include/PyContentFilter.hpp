...
namespace pyrti {
    ...
    template<typename T>
    void init_content_filter_defs(py::class_<rti::topic::ContentFilter<T, py::object>, pyrti::PyContentFilter<T>>& cls) {
        cls
            .def(
                "compile",
    ...
    void init_content_filter(py::object& o) {
        py::class_<rti::topic::ContentFilter<T, py::object>, pyrti::PyContentFilter<T>> cf(o, "ContentFilter");

        pyrti::init_content_filter_defs(cf);
    }
}