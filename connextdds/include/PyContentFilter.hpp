...
public:
  ...
  dds::core::optional<py::object> &compile_helper(
    ...
    PYBIND11_OVERLOAD_PURE(dds::core::optional<py::object> &, CFBase, compile,
                           expression, parameters, type_code, type_class_name,
                           old_compile_data);
  }
  ...
  compile(const std::string &expression,
          ...
          const dds::core::optional<dds::core::xtypes::DynamicType> &type_code,
          const std::string &type_class_name,
          dds::core::optional<py::object> *old_compile_data) override {
    auto compile_data = compile_helper(expression, parameters, type_code,
                                       type_class_name, old_compile_data);
    if (nullptr != old_compile_data) {
      delete old_compile_data;
    }
    if (has_value(compile_data))
      get_value(compile_data).inc_ref();
    return *(new dds::core::optional<py::object>(compile_data));
  }

  bool evaluate(dds::core::optional<py::object> &compile_data, const T &sample,
                const rti::topic::FilterSampleInfo &meta_data) override {
    PYBIND11_OVERLOAD_PURE(bool, CFBase, evaluate, compile_data, sample,
                           meta_data);
  }

  void finalize_helper(dds::core::optional<py::object> &compile_data) {
    PYBIND11_OVERLOAD_PURE(void, CFBase, finalize, compile_data);
  }

  void finalize(dds::core::optional<py::object> &compile_data) override {
...
void init_content_filter(
    py::class_<rti::topic::ContentFilter<T, dds::core::optional<py::object>>,
               rti::topic::ContentFilterBase, PyContentFilter<T>> &cf) {
