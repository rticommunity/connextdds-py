...
template<typename T>
void init_content_filtered_topics_defs(py::class_<PyContentFilteredTopic<T>, PyITopicDescription<T>, PyIAnyTopic>& cls) {
    cls
        .def(
            py::init<
                PyTopic<T>&,
        ...
        .def(
            py::init(
                [](PyITopicDescription<T>& td) {
                    auto desc = td.get_topic_description();
                    return dds::core::polymorphic_cast<PyContentFilteredTopic<T>>(desc);
                }
            ),
        ...
        .def(
            py::init(
                [](PyIEntity& e) {
                    ...
                    return dds::core::polymorphic_cast<PyContentFilteredTopic<T>>(entity);
                }
            ),
            py::arg("entity"),
        ...
        .def_property(
            "filter_parameters",
            (const std::vector<std::string> (PyContentFilteredTopic<T>::*)() const) 
        ...
        .def(
            ...
            [](PyContentFilteredTopic<T>& cft, int32_t index, const std::string& extension) {
        ...
        .def(
            ...
            [](PyContentFilteredTopic<T>& cft, int32_t index, const std::string& remove_term) {
