...
void init_content_filtered_topics_defs(
  ...
  cls.def(py::init<PyTopic<T> &, std::string &, dds::topic::Filter &>(),
          py::arg("topic"), py::arg("name"), py::arg("contentfilter"),
      ...
      .def(py::init([](PyITopicDescription<T> &td) {
             ...
             return dds::core::polymorphic_cast<PyContentFilteredTopic<T>>(
                 desc);
           }),
      ...
      .def(py::init([](PyIEntity &e) {
           ...
           py::arg("entity"), "Cast an Entity to a ContentFilteredTopic.")
      ...
      .def_property_readonly("filter_expression",
                             &PyContentFilteredTopic<T>::filter_expression,
                             "Get the filter expression")
      .def_property(
          "filter_parameters",
          (const std::vector<std::string> (PyContentFilteredTopic<T>::*)()
               const) &
              PyContentFilteredTopic<T>::filter_parameters,
          [](PyContentFilteredTopic<T> &cft, std::vector<std::string> &params) {
      ...
      .def(
          ...
          [](PyContentFilteredTopic<T> &cft, int32_t index,
             const std::string &extension) {
            cft->append_to_expression_parameter(index, extension);
          },
          py::arg("index"), py::arg("extension"),
          "Append the extension to the end of parameter at the provided index, "
      ...
      .def(
          ...
          py::arg("index"), py::arg("remove_term"),
          "Removes the specified term from the parameter at the provided "
          "index.")
      .def(py::self == py::self, "Test for equality.")
      .def(py::self != py::self, "Test for inequality.");

  py::implicitly_convertible<PyITopicDescription<T>,
