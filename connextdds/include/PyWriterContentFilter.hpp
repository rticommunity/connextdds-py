...
namespace pyrti {
    ...
    template<typename T>
    void init_writer_content_filter_defs(py::class_<rti::topic::WriterContentFilter<T, py::object, py::object>, pyrti::PyWriterContentFilter<T>>& cls) {
        cls
            .def(
                "writer_compile",
    ...
    void init_writer_content_filter(py::object& o) {
        py::class_<rti::topic::WriterContentFilter<T, py::object, py::object>, pyrti::PyWriterContentFilter<T>> wcf(o, "WriterContentFilter");

        pyrti::init_writer_content_filter_defs(wcf);
    }
}