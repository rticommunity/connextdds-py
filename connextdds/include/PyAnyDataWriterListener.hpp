...
public:
  ...
  virtual void
  on_liveliness_lost(PyAnyDataWriter &writer,
  ...
  virtual void
  on_instance_replaced(PyAnyDataWriter &writer,
...
public:
  ...
  void on_offered_deadline_missed(
      PyAnyDataWriter &writer,
      const dds::core::status::OfferedDeadlineMissedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, ADWLBase, on_offered_deadline_missed, writer,
                           status);
  }
  ...
  void on_offered_incompatible_qos(
      PyAnyDataWriter &writer,
      const dds::core::status::OfferedIncompatibleQosStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, ADWLBase, on_offered_incompatible_qos, writer,
                           status);
  }
  ...
  void on_liveliness_lost(
      PyAnyDataWriter &writer,
      const dds::core::status::LivelinessLostStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, ADWLBase, on_liveliness_lost, writer, status);
  }

  void on_publication_matched(
      PyAnyDataWriter &writer,
      const dds::core::status::PublicationMatchedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, ADWLBase, on_publication_matched, writer,
                           status);
  }
  ...
  void on_reliable_writer_cache_changed(
      ...
      const rti::core::status::ReliableWriterCacheChangedStatus &status)
      override {
    PYBIND11_OVERLOAD_PURE(void, ADWLBase, on_reliable_writer_cache_changed,
                           writer, status);
  }
  ...
  void on_reliable_reader_activity_changed(
      ...
      const rti::core::status::ReliableReaderActivityChangedStatus &status)
      override {
    PYBIND11_OVERLOAD_PURE(void, ADWLBase, on_reliable_reader_activity_changed,
                           writer, status);
  }

  void on_instance_replaced(PyAnyDataWriter &writer,
                            const dds::core::InstanceHandle &handle) override {
    PYBIND11_OVERLOAD_PURE(void, ADWLBase, on_instance_replaced, writer,
                           handle);
  }
  ...
  void on_application_acknowledgment(
      PyAnyDataWriter &writer,
      const rti::pub::AcknowledgmentInfo &acknowledgment_info) override {
    PYBIND11_OVERLOAD_PURE(void, ADWLBase, on_application_acknowledgment,
                           writer, acknowledgment_info);
  }

  void on_service_request_accepted(
      PyAnyDataWriter &writer,
      const rti::core::status::ServiceRequestAcceptedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, ADWLBase, on_service_request_accepted, writer,
                           status);
  }
...
public:
  ...
  void on_offered_deadline_missed(
      PyAnyDataWriter &writer,
      const dds::core::status::OfferedDeadlineMissedStatus &status) override {
    PYBIND11_OVERLOAD(void, ADWLBase, on_offered_deadline_missed, writer,
                      status);
  }
  ...
  void on_offered_incompatible_qos(
      PyAnyDataWriter &writer,
      const dds::core::status::OfferedIncompatibleQosStatus &status) override {
    PYBIND11_OVERLOAD(void, ADWLBase, on_offered_incompatible_qos, writer,
                      status);
  }
  ...
  void on_publication_matched(
      PyAnyDataWriter &writer,
      const dds::core::status::PublicationMatchedStatus &status) override {
    PYBIND11_OVERLOAD(void, ADWLBase, on_publication_matched, writer, status);
  }
  ...
  void on_reliable_writer_cache_changed(
      ...
      const rti::core::status::ReliableWriterCacheChangedStatus &status)
      override {
    PYBIND11_OVERLOAD(void, ADWLBase, on_reliable_writer_cache_changed, writer,
                      status);
  }
  ...
  void on_reliable_reader_activity_changed(
      ...
      const rti::core::status::ReliableReaderActivityChangedStatus &status)
      override {
    PYBIND11_OVERLOAD(void, ADWLBase, on_reliable_reader_activity_changed,
                      writer, status);
  }
  ...
  void on_application_acknowledgment(
      PyAnyDataWriter &writer,
      const rti::pub::AcknowledgmentInfo &acknowledgment_info) override {
    PYBIND11_OVERLOAD(void, ADWLBase, on_application_acknowledgment, writer,
                      acknowledgment_info);
  }
  ...
  void on_service_request_accepted(
      PyAnyDataWriter &writer,
      const rti::core::status::ServiceRequestAcceptedStatus &status) override {
    PYBIND11_OVERLOAD(void, ADWLBase, on_service_request_accepted, writer,
                      status);
  }
