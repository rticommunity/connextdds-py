...
template<typename T>
py::class_<T> init_mask_type_no_int_constructor(py::object& m, const std::string& name, const std::string& noarg_constructor_doc_str = "Creates a mask with no bits set.") {
    py::class_<T> mt(m, name.c_str());
    mt
        .def(
            py::init<>(),
            noarg_constructor_doc_str.c_str()
        )
        .def(
            "__getitem__",
...
py::class_<T> init_mask_type(py::object& m, const std::string& name, const std::string& noarg_constructor_doc_str = "Creates a mask with no bits set.") {
    auto mt = init_mask_type_no_int_constructor<T>(m, name, noarg_constructor_doc_str);
    mt
        .def(
            py::init<
                INIT_TYPE
