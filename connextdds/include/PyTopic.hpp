...
template <typename T> class PyTopicListener;

template <typename T> class PyITopicDescription : public PyIEntity {
public:
...
public:
  ...
  PyTopic(const PyDomainParticipant &dp, const std::string &n,
          const dds::topic::qos::TopicQos &q, PyTopicListener<T> *l,
  ...
  PyTopic(const PyDomainParticipant &dp, const std::string &n,
          const std::string &tn, const dds::topic::qos::TopicQos &q,
          PyTopicListener<T> *l, const dds::core::status::StatusMask &m)
...
void init_itopic_description_defs(
  ...
  cls.def_property_readonly(
         "name", &PyITopicDescription<T>::py_name,
         "The name of the entity conforming to the ITopicDescription "
         "interface.")
      .def_property_readonly("type_name", &PyITopicDescription<T>::py_type_name,
                             "The name of the associated type.")
      .def_property_readonly("participant",
...
void init_dds_typed_topic_base_template(
  ...
  cls.def(py::init([](PyIEntity &e) {
      ...
      .def(
          "bind_listener",
          [](PyTopic<T> &t, dds::core::optional<PyTopicListener<T> *> l,
             const dds::core::status::StatusMask &m) {
      ...
      .def_property_readonly(
          "inconsistent_topic_status", &PyTopic<T>::inconsistent_topic_status,
...
void init_dds_typed_topic_template(
  ...
  cls.def(py::init<const PyDomainParticipant &, const std::string &>(),
          py::arg("participant"), py::arg("topic_name"),
          py::call_guard<py::gil_scoped_release>(), "Creates a new Topic.")
      .def(py::init<const PyDomainParticipant &, const std::string &,
                    const std::string &>(),
           py::arg("participant"), py::arg("topic_name"), py::arg("type_name"),
           py::call_guard<py::gil_scoped_release>(), "Creates a new Topic.")
      .def(py::init([](const PyDomainParticipant &dp, const std::string &n,
           ...
           py::arg("participant"), py::arg("topic_name"), py::arg("qos"),
           py::arg("listener") = py::none(),
           py::arg_v("mask", dds::core::status::StatusMask::all(),
                     "StatusMask.all()"),
           py::call_guard<py::gil_scoped_release>(), "Creates a new Topic.")
      .def(py::init([](const PyDomainParticipant &dp, const std::string &n,
                       const std::string &t, const dds::topic::qos::TopicQos &q,
                       dds::core::optional<PyTopicListener<T> *> l,
                       const dds::core::status::StatusMask &m) {
             auto listener = has_value(l) ? get_value(l) : nullptr;
