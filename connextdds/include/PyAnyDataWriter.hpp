...
namespace pyrti {
    ...
    public:
        virtual 
        dds::pub::AnyDataWriter get_any_datawriter() const = 0;

        virtual
        dds::pub::qos::DataWriterQos py_qos() const = 0;

        virtual
        void py_qos(const dds::pub::qos::DataWriterQos&) = 0;
        ...
        virtual
        const pyrti::PyPublisher py_publisher() const = 0;

        virtual 
        void py_wait_for_acknowledgments(const dds::core::Duration&) = 0;
    ...
    class PyAnyDataWriter : public dds::pub::AnyDataWriter, public PyIAnyDataWriter {
    public:
        using dds::pub::AnyDataWriter::AnyDataWriter;
        
        PyAnyDataWriter(dds::pub::AnyDataWriter& adw) : dds::pub::AnyDataWriter(adw) {}

        PyAnyDataWriter(const dds::pub::AnyDataWriter& adw) : dds::pub::AnyDataWriter(adw) {}

        PyAnyDataWriter(const pyrti::PyIAnyDataWriter& adw) : dds::pub::AnyDataWriter(adw.get_any_datawriter()) {}
        ...
        const pyrti::PyPublisher py_publisher() const override { 
            ...
            return pyrti::PyPublisher(p); 
        }

        void py_wait_for_acknowledgments(const dds::core::Duration& timeout) override { this->wait_for_acknowledgments(timeout); }
