...
public:
    using PyDataReaderListenerTrampoline<T, DRLBase>::
            PyDataReaderListenerTrampoline;
    ...
    cls.def(py::init<>())
            .def("on_requested_deadline_missed",
                 (void (PyDataReaderListener<T>::*)(
                         ...
                         & PyDataReaderListener<
                                 T>::on_requested_deadline_missed,
            ...
            .def("on_requested_incompatible_qos",
                 (void (PyDataReaderListener<T>::*)(
                         ...
                         & PyDataReaderListener<
                                 T>::on_requested_incompatible_qos,
