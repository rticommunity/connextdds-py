...
void add_qos_property(py::class_<T> &cls, const std::string &field_name,
                      const std::string &property_name) {
  cls.def_property(field_name.c_str(),
...
#endif
           py::is_operator(), ("Set the " + property_name + "QoS.").c_str())
      .def("__rshift__",
#if defined(_MS_VER) && _MS_VER <= 1900
...
#endif
           py::is_operator(), ("Get the " + property_name + "QoS.").c_str());
}
