...
public:
  ...
  virtual void
  on_sample_rejected(PyAnyDataReader &reader,
...
public:
  ...
  void on_requested_deadline_missed(
      PyAnyDataReader &reader,
      const dds::core::status::RequestedDeadlineMissedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, ADRLBase, on_requested_deadline_missed, reader,
                           status);
  }
  ...
  void on_requested_incompatible_qos(
      ...
      const dds::core::status::RequestedIncompatibleQosStatus &status)
      override {
    PYBIND11_OVERLOAD_PURE(void, ADRLBase, on_requested_incompatible_qos,
                           reader, status);
  }
  ...
  void on_sample_rejected(
      PyAnyDataReader &reader,
      const dds::core::status::SampleRejectedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, ADRLBase, on_sample_rejected, reader, status);
  }

  void on_liveliness_changed(
      PyAnyDataReader &reader,
      const dds::core::status::LivelinessChangedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, ADRLBase, on_liveliness_changed, reader,
                           status);
  }
  ...
  void on_subscription_matched(
      PyAnyDataReader &reader,
      const dds::core::status::SubscriptionMatchedStatus &status) override {
    PYBIND11_OVERLOAD_PURE(void, ADRLBase, on_subscription_matched, reader,
                           status);
  }
...
public:
  ...
  void on_requested_deadline_missed(
      PyAnyDataReader &reader,
      const dds::core::status::RequestedDeadlineMissedStatus &status) override {
    PYBIND11_OVERLOAD(void, ADRLBase, on_requested_deadline_missed, reader,
                      status);
  }
  ...
  void on_requested_incompatible_qos(
      ...
      const dds::core::status::RequestedIncompatibleQosStatus &status)
      override {
    PYBIND11_OVERLOAD(void, ADRLBase, on_requested_incompatible_qos, reader,
                      status);
  }
  ...
  void on_liveliness_changed(
      PyAnyDataReader &reader,
      const dds::core::status::LivelinessChangedStatus &status) override {
    PYBIND11_OVERLOAD(void, ADRLBase, on_liveliness_changed, reader, status);
  }
  ...
  void on_subscription_matched(
      PyAnyDataReader &reader,
      const dds::core::status::SubscriptionMatchedStatus &status) override {
    PYBIND11_OVERLOAD(void, ADRLBase, on_subscription_matched, reader, status);
  }
