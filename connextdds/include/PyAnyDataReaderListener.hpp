...
class PyNoOpAnyDataReaderListenerTrampoline : public PyAnyDataReaderListenerTrampoline<ADRLBase> {
public:
    using PyAnyDataReaderListenerTrampoline<ADRLBase>::PyAnyDataReaderListenerTrampoline;

    using PyAnyDataReaderListenerTrampoline<ADRLBase>::on_requested_deadline_missed;
    using PyAnyDataReaderListenerTrampoline<ADRLBase>::on_requested_incompatible_qos;
