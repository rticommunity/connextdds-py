...
class PyNoOpTopicListenerTrampoline : public PyTopicListenerTrampoline<T, TLBase> {
public:
...
template<typename T>
void init_topic_listener_defs(py::class_<PyTopicListener<T>, PyTopicListenerTrampoline<T>>& cls) {
    cls
        .def(
            py::init<>()
        )
        .def(
            "on_inconsistent_topic",
            (void (PyTopicListener<T>::*)(PyTopic<T>&, const dds::core::status::InconsistentTopicStatus&)) &PyTopicListener<T>::on_inconsistent_topic,
...
void init_noop_topic_listener_defs(py::class_<PyNoOpTopicListener<T>, PyTopicListener<T>, PyNoOpTopicListenerTrampoline<T>>& cls) {
    cls
        ...
        .def(
            "on_inconsistent_topic",
            (void (PyNoOpTopicListener<T>::*)(PyTopic<T>&, const dds::core::status::InconsistentTopicStatus&)) &PyNoOpTopicListener<T>::on_inconsistent_topic,
            "Inconsistent topic callback."
        );
}
...
void init_topic_listener(
    ...
    py::class_<PyNoOpTopicListener<T>, PyTopicListener<T>, PyNoOpTopicListenerTrampoline<T>>& notl
) {
