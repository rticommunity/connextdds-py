...
class PyNoOpDataWriterListenerTrampoline : public PyDataWriterListenerTrampoline<T, DWLBase> {
public:
    using PyDataWriterListenerTrampoline<T, DWLBase>::PyDataWriterListenerTrampoline;
    ...
    using PyDataWriterListenerTrampoline<T, DWLBase>::on_reliable_writer_cache_changed;
    using PyDataWriterListenerTrampoline<T, DWLBase>::on_reliable_reader_activity_changed;
    using PyDataWriterListenerTrampoline<T, DWLBase>::on_instance_replaced;
    using PyDataWriterListenerTrampoline<T, DWLBase>::on_application_acknowledgment;
...
template<typename T>
void init_class_defs(py::class_<PyDataWriterListener<T>, PyDataWriterListenerTrampoline<T>>& cls) {
    cls
        .def(
            py::init<>()
        )
        .def(
            "on_offered_deadline_missed",
            (void (PyDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::status::OfferedDeadlineMissedStatus&)) &PyDataWriterListener<T>::on_offered_deadline_missed,
            "Offered deadline missed callback."
        )
        .def(
            "on_offered_incompatible_qos",
            (void (PyDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::status::OfferedIncompatibleQosStatus&)) &PyDataWriterListener<T>::on_offered_incompatible_qos,
            "Offered incompatible QoS callback."
        )
        .def(
            "on_liveliness_lost",
            (void (PyDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::status::LivelinessLostStatus&)) &PyDataWriterListener<T>::on_liveliness_lost,
            "Liveliness lost callback."
        )
        .def(
            "on_publication_matched",
            (void (PyDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::status::PublicationMatchedStatus&)) &PyDataWriterListener<T>::on_publication_matched,
            "Publication matched callback."
        )
        .def(
            "on_reliable_writer_cache_changed",
            (void (PyDataWriterListener<T>::*)(PyDataWriter<T>&, const rti::core::status::ReliableWriterCacheChangedStatus&)) &PyDataWriterListener<T>::on_reliable_writer_cache_changed,
            "Reliable writer cache changed callback."
        )
        .def(
            "on_reliable_reader_activity_changed",
            (void (PyDataWriterListener<T>::*)(PyDataWriter<T>&, const rti::core::status::ReliableReaderActivityChangedStatus&)) &PyDataWriterListener<T>::on_reliable_reader_activity_changed,
            "Reliable reader activity changed callback."
        )
        .def(
            "on_instance_replaced",
            (void (PyDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::InstanceHandle&)) &PyDataWriterListener<T>::on_instance_replaced,
            "On instance replaced callback."
        )
        .def(
            "on_application_acknowledgment",
            (void (PyDataWriterListener<T>::*)(PyDataWriter<T>&, const rti::pub::AcknowledgmentInfo&)) &PyDataWriterListener<T>::on_application_acknowledgment,
            "On application acknowledgment callback"
        )
        .def(
            "on_service_request_accepted",
            (void (PyDataWriterListener<T>::*)(PyDataWriter<T>&, const rti::core::status::ServiceRequestAcceptedStatus&)) &PyDataWriterListener<T>::on_service_request_accepted,
...
template<typename T>
void init_class_defs(py::class_<PyNoOpDataWriterListener<T>, PyNoOpDataWriterListenerTrampoline<T>>& cls) {
    cls
        .def(
            py::init<>()
        )
        .def(
            "on_offered_deadline_missed",
            (void (PyNoOpDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::status::OfferedDeadlineMissedStatus&)) &PyNoOpDataWriterListener<T>::on_offered_deadline_missed,
            "Offered deadline missed callback."
        )
        .def(
            "on_offered_incompatible_qos",
            (void (PyNoOpDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::status::OfferedIncompatibleQosStatus&)) &PyNoOpDataWriterListener<T>::on_offered_incompatible_qos,
            "Offered incompatible QoS callback."
        )
        .def(
            "on_liveliness_lost",
            (void (PyNoOpDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::status::LivelinessLostStatus&)) &PyNoOpDataWriterListener<T>::on_liveliness_lost,
            "Liveliness lost callback."
        )
        .def(
            "on_publication_matched",
            (void (PyNoOpDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::status::PublicationMatchedStatus&)) &PyNoOpDataWriterListener<T>::on_publication_matched,
            "Publication matched callback."
        )
        .def(
            "on_reliable_writer_cache_changed",
            (void (PyNoOpDataWriterListener<T>::*)(PyDataWriter<T>&, const rti::core::status::ReliableWriterCacheChangedStatus&)) &PyNoOpDataWriterListener<T>::on_reliable_writer_cache_changed,
            "Reliable writer cache changed callback."
        )
        .def(
            "on_reliable_reader_activity_changed",
            (void (PyNoOpDataWriterListener<T>::*)(PyDataWriter<T>&, const rti::core::status::ReliableReaderActivityChangedStatus&)) &PyNoOpDataWriterListener<T>::on_reliable_reader_activity_changed,
            "Reliable reader activity changed callback."
        )
        .def(
            "on_instance_replaced",
            (void (PyNoOpDataWriterListener<T>::*)(PyDataWriter<T>&, const dds::core::InstanceHandle&)) &PyNoOpDataWriterListener<T>::on_instance_replaced,
            "On instance replaced callback."
        )
        .def(
            "on_application_acknowledgment",
            (void (PyNoOpDataWriterListener<T>::*)(PyDataWriter<T>&, const rti::pub::AcknowledgmentInfo&)) &PyNoOpDataWriterListener<T>::on_application_acknowledgment,
            "On application acknowledgment callback"
        )
        .def(
            "on_service_request_accepted",
            (void (PyNoOpDataWriterListener<T>::*)(PyDataWriter<T>&, const rti::core::status::ServiceRequestAcceptedStatus&)) &PyNoOpDataWriterListener<T>::on_service_request_accepted,
            "On service request accepted callback."
        );
        /*.def(
            "on_destination_unreachable",
...
void init_datawriter_listener(py::object& o) {
    ...
    py::class_<PyNoOpDataWriterListener<T>, PyNoOpDataWriterListenerTrampoline<T>> nodwl(o, "NoOpDataWriterListener");
