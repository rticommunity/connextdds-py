...
template<>
void pyrti::init_class_defs(py::class_<OfferedDeadlineMissedStatus>& cls) {
    cls
...
template<>
void pyrti::process_inits<OfferedDeadlineMissedStatus>(py::module& m, pyrti::ClassInitList& l) {
    l.push_back(
        [m]() mutable {
            return pyrti::init_class<OfferedDeadlineMissedStatus>(m, "OfferedDeadlineMissedStatus");
        }
    ); 
}