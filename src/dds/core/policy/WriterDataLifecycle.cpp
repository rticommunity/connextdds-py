...
template<>
void pyrti::init_class_defs(py::class_<WriterDataLifecycle>& cls) {
    cls
        .def(
            py::init<>(),
        ...
        .def(
            ...
            >(),
            py::arg("autodispose"),
            "Creates an instance with a value for auto-dispose unregistered "
            "instances and default values for the rest of parameters."
        )
        .def_property(
            "autodispose_unregistered_instances",
            (bool (WriterDataLifecycle::*)() const) &WriterDataLifecycle::autodispose_unregistered_instances,
            (WriterDataLifecycle& (WriterDataLifecycle::*)(bool)) &WriterDataLifecycle::autodispose_unregistered_instances,
            "Indicates whether the DataWriter should automatically dispose "
...
template<>
void pyrti::process_inits<WriterDataLifecycle>(py::module& m, pyrti::ClassInitList& l) {
    l.push_back(
        [m]() mutable {
            return pyrti::init_class<WriterDataLifecycle>(m, "WriterDataLifecycle");
        }
    );    
}