...
void pyrti::init_class_defs(py::class_<PrintFormatProperty>& cls) {
    cls
        ...
        .def_property(
            "kind",
            (PrintFormatKind (PrintFormatProperty::*)() const) &PrintFormatProperty::kind,
            (PrintFormatProperty& (PrintFormatProperty::*)(PrintFormatKind)) &PrintFormatProperty::kind,
            "Get/set the kind value."
        )
        .def_property(
            "pretty_print",
            (bool (PrintFormatProperty::*)() const) &PrintFormatProperty::pretty_print,
            (PrintFormatProperty& (PrintFormatProperty::*)(bool)) &PrintFormatProperty::pretty_print,
            "Get/set the value of pretty_print."
        )
        .def_property(
            "enum_as_int",
            (bool (PrintFormatProperty::*)() const) &PrintFormatProperty::enum_as_int,
            (PrintFormatProperty& (PrintFormatProperty::*)(bool)) &PrintFormatProperty::enum_as_int,
            "Get/set the value of enum_as_int."
        )
        .def_property(
            "include_root_elements",
            (bool (PrintFormatProperty::*)() const) &PrintFormatProperty::include_root_elements,
            (PrintFormatProperty& (PrintFormatProperty::*)(bool)) &PrintFormatProperty::include_root_elements,
