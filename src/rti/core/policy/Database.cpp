...
void pyrti::init_class_defs(py::class_<Database>& cls) {
    cls
        ...
        .def_property(
            "thread",
            (ThreadSettings& (Database::*)()) &Database::thread,
            (Database& (Database::*)(const ThreadSettings&)) &Database::thread,
            "Get/set the thread settings for the Database thread."
        )
        .def_property(
            "shutdown_timeout",
            (Duration (Database::*)() const) &Database::shutdown_timeout,
            (Database& (Database::*)(const Duration&)) &Database::shutdown_timeout,
            "Get/set the shutdown timeout."
        )
        .def_property(
            "cleanup_period",
            (Duration (Database::*)() const) &Database::cleanup_period,
            (Database& (Database::*)(const Duration&)) &Database::cleanup_period,
            "Get/set the cleanup period."
        )
        .def_property(
            "shutdown_cleanup_period",
            (Duration (Database::*)() const) &Database::shutdown_cleanup_period,
            (Database& (Database::*)(const Duration&)) &Database::shutdown_cleanup_period,
        ...
        .def_property(
            ...
            (int32_t (Database::*)() const) &Database::initial_weak_references,
            (Database& (Database::*)(int32_t)) &Database::initial_weak_references,
