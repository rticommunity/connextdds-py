...
void pyrti::init_class_defs(py::class_<DataWriterResourceLimits>& cls) {
    cls
        ...
        .def_property(
            ...
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::initial_concurrent_blocking_threads,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::initial_concurrent_blocking_threads,
            "The initial number of threads that are allowed to concurrently "
            "block on write call on the same DataWriter."
        )
        .def_property(
            "max_concurrent_blocking_threads",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::max_concurrent_blocking_threads,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::max_concurrent_blocking_threads,
            "The maximum number of threads that are allowed to concurrently "
            "block on write call on the same DataWriter."
        )
        .def_property(
            "max_remote_reader_filters",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::max_remote_reader_filters,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::max_remote_reader_filters,
            "The maximum number of remote DataReaders for which the "
            "DataWriter will perform content-based filtering."
        )
        .def_property(
            "initial_batches",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::initial_batches,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::initial_batches,
            "Represents the initial number of batches a DataWriter will "
            "manage."
        )
        .def_property(
            "max_batches",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::max_batches,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::max_batches,
            "Represents the maximum number of batches a DataWriter will "
            "manage."
        )
        .def_property(
            "cookie_max_length",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::cookie_max_length,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::cookie_max_length,
            "Represents the maximum length in bytes of a Cookie."
        )
        .def_property(
            "instance_replacement",
            (DataWriterResourceLimitsInstanceReplacementKind (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::instance_replacement,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(DataWriterResourceLimitsInstanceReplacementKind)) &DataWriterResourceLimits::instance_replacement,
            "Sets the kinds of instances allowed to be replaced when instance "
            "resource limits are reached."
        )
        .def_property(
            "replace_empty_instances",
            (bool (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::replace_empty_instances,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(bool)) &DataWriterResourceLimits::replace_empty_instances,
            "Whether or not to replace empty instances during instance "
            "replacement."
        )
        .def_property(
            "autoregister_instances",
            (bool (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::autoregister_instances,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(bool)) &DataWriterResourceLimits::autoregister_instances,
            "Whether or not to automatically register new instances."
        )
        .def_property(
            "initial_virtual_writers",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::initial_virtual_writers,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::initial_virtual_writers,
            "The initial number of virtual writers supported by a DataWriter."
        )
        .def_property(
            "max_virtual_writers",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::max_virtual_writers,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::max_virtual_writers,
            "The maximum number of virtual writers supported by a DataWriter."
        )
        .def_property(
            "max_remote_readers",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::max_remote_readers,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::max_remote_readers,
            "The maximum number of remote readers supported by a DataWriter."
        )
        .def_property(
            "max_app_ack_remote_readers",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::max_app_ack_remote_readers,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::max_app_ack_remote_readers,
            "The maximum number of application-level acknowledging remote "
            "readers supported by a DataWriter."
        )
        .def_property(
            "initial_active_topic_queries",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::initial_active_topic_queries,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::initial_active_topic_queries,
            "Represents the initial number of active topic queries a "
            "DataWriter will manage."
        )
        .def_property(
            "max_active_topic_queries",
            (int32_t (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::max_active_topic_queries,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(int32_t)) &DataWriterResourceLimits::max_active_topic_queries,
        ...
        .def_property(
            ...
            [](DataWriterResourceLimits& dwrl, rti::core::AllocationSettings& as) {
                dwrl.writer_loaned_sample_allocation() = as;
            },
            "Represents the allocation settings of loaned samples managed by "
            "a DataWriter."
        )
        .def_property(
            "initialize_writer_loaned_sample",
            (bool (DataWriterResourceLimits::*)() const) &DataWriterResourceLimits::initialize_writer_loaned_sample,
            (DataWriterResourceLimits& (DataWriterResourceLimits::*)(bool)) &DataWriterResourceLimits::initialize_writer_loaned_sample,
...
void pyrti::process_inits<DataWriterResourceLimits>(py::module& m, pyrti::ClassInitList& l) {
    ...
    py::enum_<DataWriterResourceLimitsInstanceReplacementKind::type>(dwrlirk, "DataWriterResourceLimitsInstaceReplacementKind")
        ...
        .value(
            ...
            "\n\n"
            "When an unregistered, acknowledged instance is not available "
            "to reclaim, this kind allows a dds::pub::DataWriter to first "
        ...
        .value(
            ...
            "\n\n"
            "When an unregistered acknowledged instance is not available to "
            "reclaim, this kind allows a dds::pub::DataWriter to reclaim "
